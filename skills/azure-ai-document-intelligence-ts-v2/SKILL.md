...
```text
Review @azure-ai-document-intelligence-ts-v2 against EXTERNAL_SOURCE.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
