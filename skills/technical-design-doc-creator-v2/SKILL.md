---
name: technical-design-doc-creator-v2
...
tags: ["technical-design-doc-creator-v2", "technical-design-doc-creator", "creates", "comprehensive", "technical", "design", "documents", "tdd"]
complexity: advanced
risk: caution
...
```text
Use @technical-design-doc-creator-v2 to handle <task>. Start with the workflow playbook, load only the upstream files that change the outcome, and keep provenance visible in the answer.
```
...
```bash
python3 skills/technical-design-doc-creator-v2/scripts/omni_import_print_origin.py
```
...
```bash
python3 skills/technical-design-doc-creator-v2/scripts/omni_import_list_support_pack.py
```
...
```text
Review @technical-design-doc-creator-v2 using the checklist, rubric, playbook, and source manifest, then summarize any gaps before merge.
```
...
**Symptoms:** The result ignores the upstream workflow in `packages/skills-catalog/skills/(creation)/create-technical-design-doc`, fails to mention provenance, or does not use the support pack at all.
