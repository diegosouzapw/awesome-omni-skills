...
tags: ["social-post-writer-seo", "social", "media", "strategist", "and", "content", "writer", "creates"]
complexity: beginner
risk: safe
...
This public intake copy packages `plugins/antigravity-awesome-skills-claude/skills/social-post-writer-seo` from `https://github.com/sickn33/antigravity-awesome-skills` into the native Omni Skills editorial shape without hiding its origin.
