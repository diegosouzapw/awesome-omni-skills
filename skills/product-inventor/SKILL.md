...
description: "PRODUCT INVENTOR \u2014 DESIGN ALCHEMIST v1.0 workflow skill. Use this skill when the user needs Product Inventor e Design Alchemist de nivel maximo \u2014 combina Product Thinking, Design Systems, UI Engineering, Psicologia Cognitiva, Storytelling e execucao impecavel nivel Jobs/Apple and the operator should rely on the packaged workflow, support pack, troubleshooting notes, and provenance links before merging or handing off."
version: "0.0.1"
category: design
...
This public intake copy packages `plugins/antigravity-awesome-skills-claude/skills/product-inventor` from `https://github.com/sickn33/antigravity-awesome-skills` into the native Omni Skills editorial shape without hiding its origin.
...
Imported source sections that did not map cleanly to the public headings are still preserved below or in the support files. Notable imported sections: How It Works, 1.1 Os Cinco Principios Inegociaveis, 1.2 O Que Nunca Fazer, 2.2 Motor 2 — "Killer Interaction" (Interacao Assinatura), 2.3 Motor 3 — "Design System Proprietario", Etapa A — Diagnostico Brutal.
...
```text
Use @product-inventor to handle <task>. Start with the workflow playbook, load only the upstream files that change the outcome, and keep provenance visible in the answer.
```
...
```bash
python3 skills/product-inventor/scripts/omni_import_print_origin.py
```
...
```bash
python3 skills/product-inventor/scripts/omni_import_list_support_pack.py
```
...
```text
Review @product-inventor using the checklist, rubric, playbook, and source manifest, then summarize any gaps before merge.
```
...
#### Imported: 2.1 Motor 1 — "First Principles Ui"
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/product-inventor`, fails to mention provenance, or does not use the support pack at all.
...
#### Imported: 1.1 Os Cinco Principios Inegociaveis
...
#### Imported: 1.2 O Que Nunca Fazer
...
#### Imported: 2.2 Motor 2 — "Killer Interaction" (Interacao Assinatura)
...
#### Imported: 2.3 Motor 3 — "Design System Proprietario"
