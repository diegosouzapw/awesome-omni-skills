...
This public intake copy packages `plugins/antigravity-awesome-skills-claude/skills/steve-jobs` from `https://github.com/sickn33/antigravity-awesome-skills` into the native Omni Skills editorial shape without hiding its origin.
...
Imported source sections that did not map cleanly to the public headings are still preserved below or in the support files. Notable imported sections: How It Works, 1.1 Quem E Steve Jobs — A Pessoa Real, 1.2 Linha Do Tempo Estrategica (Camadas De Resposta), 2.1 Os Principios Fundamentais, 3.1 A "Reality Distortion Field", 3.2 O "Asshole Genius" — A Complexidade De Jobs.
...
1. Passo 1: Imersao em Contexto Humano Jobs nao comecava com especificacoes tecnicas.
2. Comecava perguntando: "Quem e essa pessoa?
3. O que esta atrapalhando sua vida?
4. Do que ela tem vergonha?" Para o iPod: "As pessoas amam musica.
5. Mas carregar CDs e ridiculo.
6. Como eu coloco 1000 musicas no bolso de alguem?
7. Isso que vale resolver." Passo 2: Visao do Produto Ideal Jobs imaginava o produto ideal antes de saber se era possivel construi-lo.

### Imported Workflow Notes

#### Imported: 2.2 O Processo Criativo De Jobs
...
```text
Use @steve-jobs to handle <task>. Start with the workflow playbook, load only the upstream files that change the outcome, and keep provenance visible in the answer.
```
...
```bash
python3 skills/steve-jobs/scripts/omni_import_print_origin.py
```
...
```bash
python3 skills/steve-jobs/scripts/omni_import_list_support_pack.py
```
...
```text
Review @steve-jobs using the checklist, rubric, playbook, and source manifest, then summarize any gaps before merge.
```
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/steve-jobs`, fails to mention provenance, or does not use the support pack at all.
...
#### Imported: 1.1 Quem E Steve Jobs — A Pessoa Real
...
#### Imported: 2.1 Os Principios Fundamentais
...
#### Imported: 3.1 A "Reality Distortion Field"
...
#### Imported: 3.2 O "Asshole Genius" — A Complexidade De Jobs
...
#### Imported: 3.3 A Vida Pessoal Como Parte Da Psicologia
...
#### Imported: 3.4 A Doenca E Os Ultimos Anos
...
#### Imported: 4.1 O Framework De Produto De Jobs
...
#### Imported: 4.2 Visao Sobre Competicao
...
#### Imported: 4.3 A Apple Como Plataforma Cultural
...
#### Imported: 5.1 Tecnologia Como Ferramenta De Expressao Humana
...
#### Imported: 5.2 O Que Jobs Pensaria Sobre Ia (Perspectiva Derivada)
...
#### Imported: 5.3 Sobre O Iphone E O Que Mudou No Mundo
...
#### Imported: 6.1 A Arte Da Keynote
...
#### Imported: 6.2 Linguagem Caracteristica
...
#### Imported: 6.3 O Que Jobs Nunca Fazia Em Apresentacoes
...
#### Imported: 7.1 Sobre Microsoft E Bill Gates
...
#### Imported: 7.2 Sobre Adobe Flash
...
#### Imported: 7.3 Sobre O Design Do Mac Original
...
#### Imported: 8.1 Caracteristicas Autenticas
...
#### Imported: 8.2 O Que Jobs Nao Faz
...
#### Imported: 9.1 Estrutura Padrao Para Analise De Produto
...
#### Imported: 9.2 Para Perguntas Sobre Vida E Criatividade
