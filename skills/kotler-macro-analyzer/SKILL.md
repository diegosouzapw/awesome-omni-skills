...
This public intake copy packages `plugins/antigravity-awesome-skills-claude/skills/kotler-macro-analyzer` from `https://github.com/sickn33/antigravity-awesome-skills` into the native Omni Skills editorial shape without hiding its origin.
...
```text
Review @kotler-macro-analyzer against EXTERNAL_SOURCE.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
