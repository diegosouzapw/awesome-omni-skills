# Origin for multi-platform-launch-v2
...
- Source skill path: `packages/skills-catalog/skills/(gtm)/multi-platform-launch`
- Imported public skill id: `multi-platform-launch-v2`
