...
version: "0.0.1"
category: frontend
tags: ["frontend", "design", "minimalism", "ui", "minimalist-ui", "creating", "clean", "editorial"]
complexity: advanced
risk: safe
...
This public intake copy packages `plugins/antigravity-awesome-skills-claude/skills/minimalist-ui` from `https://github.com/sickn33/antigravity-awesome-skills` into the native Omni Skills editorial shape without hiding its origin.
...
```text
Review @minimalist-ui against EXTERNAL_SOURCE.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/minimalist-ui`, fails to mention provenance, or does not use any copied source files at all.
