...
tags: ["git-pr-review", "generate", "concise", "and", "structured", "description", "commit", "history"]
complexity: beginner
risk: caution
...
This public intake copy packages `plugins/antigravity-awesome-skills-claude/skills/git-pr-review` from `https://github.com/sickn33/antigravity-awesome-skills` into the native Omni Skills editorial shape without hiding its origin.
