...
This public intake copy packages `plugins/antigravity-awesome-skills/skills/squirrel` from `https://github.com/sickn33/antigravity-awesome-skills` into the native Omni Skills editorial shape without hiding its origin.
