...
```text
Review @wordpress-centric-high-seo-optimized-blogwriting-skill against EXTERNAL_SOURCE.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
