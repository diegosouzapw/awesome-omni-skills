...
```text
Review @azure-ai-vision-imageanalysis-py-v2 against EXTERNAL_SOURCE.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
