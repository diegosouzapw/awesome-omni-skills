---
name: component-identification-sizing-v2
...
version: "0.0.1"
category: frontend
tags: ["component-identification-sizing-v2", "component-identification-sizing", "maps", "architectural", "components", "codebase", "and", "measures"]
complexity: advanced
risk: caution
...
```text
Use @component-identification-sizing-v2 to handle <task>. Start with the workflow playbook, load only the upstream files that change the outcome, and keep provenance visible in the answer.
```
...
```bash
python3 skills/component-identification-sizing-v2/scripts/omni_import_print_origin.py
```
...
```bash
python3 skills/component-identification-sizing-v2/scripts/omni_import_list_support_pack.py
```
...
```text
Review @component-identification-sizing-v2 using the checklist, rubric, playbook, and source manifest, then summarize any gaps before merge.
```
