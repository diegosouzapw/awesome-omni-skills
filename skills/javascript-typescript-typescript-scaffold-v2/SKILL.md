...
```text
Review @javascript-typescript-typescript-scaffold-v2 against EXTERNAL_SOURCE.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
