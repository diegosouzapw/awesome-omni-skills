...
tags: ["architecture-patterns", "master", "proven", "backend", "architecture", "patterns", "including", "clean"]
complexity: beginner
risk: caution
...
```text
Review @architecture-patterns against EXTERNAL_SOURCE.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
