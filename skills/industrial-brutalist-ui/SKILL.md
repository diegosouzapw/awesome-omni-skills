...
version: "0.0.1"
category: frontend
tags: ["frontend", "design", "brutalism", "ui", "industrial-brutalist-ui", "creating", "raw", "industrial"]
complexity: advanced
risk: caution
...
This public intake copy packages `plugins/antigravity-awesome-skills-claude/skills/industrial-brutalist-ui` from `https://github.com/sickn33/antigravity-awesome-skills` into the native Omni Skills editorial shape without hiding its origin.
...
```text
Review @industrial-brutalist-ui against EXTERNAL_SOURCE.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/industrial-brutalist-ui`, fails to mention provenance, or does not use any copied source files at all.
