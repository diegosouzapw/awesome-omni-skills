...
- public `v0.9.10` and private `v1.0.0` are the current stable release floor
...
- discovery, install, API, and TUI now resolve duplicate-looking entries through the implemented `family`, `variant`, and `provenance` model
