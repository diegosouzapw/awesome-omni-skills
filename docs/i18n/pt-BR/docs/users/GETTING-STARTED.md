...
| Metric | Value |
|:-------|:------|
| Native catalog | **4556** skills across 17 active categories, including architecture, design, security, DevOps, AI-engineering, and imported native intake |
| Curated output | **1509** enhanced English derivatives in `skills_omni/` |
