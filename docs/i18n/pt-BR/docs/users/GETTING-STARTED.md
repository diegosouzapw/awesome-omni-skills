...
| Metric | Value |
|:-------|:------|
| Native catalog | **3876** skills across 17 active categories, including architecture, design, security, DevOps, AI-engineering, and imported native intake |
| Curated output | **866** enhanced English derivatives in `skills_omni/` |
