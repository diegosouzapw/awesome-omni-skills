...
| Metric | Value |
|:-------|:------|
| Native catalog | **4474** skills across 17 active categories, including architecture, design, security, DevOps, AI-engineering, and imported native intake |
| Curated output | **1427** enhanced English derivatives in `skills_omni/` |
