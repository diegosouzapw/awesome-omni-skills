...
| Metric | Value |
|:-------|:------|
| Native catalog | **3323** skills across 17 active categories, including architecture, design, security, DevOps, AI-engineering, and imported native intake |
| Curated output | **413** enhanced English derivatives in `skills_omni/` |
