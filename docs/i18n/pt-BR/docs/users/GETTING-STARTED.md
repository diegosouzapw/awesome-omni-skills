...
<!-- generated:i18n-doc: project=awesome-omni-skills; source=docs/users/GETTING-STARTED.md; version=0.12.9; release=v0.12.9; english_snapshot=2026-04-25T00:00:00+00:00 -->
...
| Metric | Value |
|:-------|:------|
| Native catalog | **3087** skills across 17 active categories, including architecture, design, security, DevOps, AI-engineering, and imported native intake |
| Curated output | **297** enhanced English derivatives in `skills_omni/` |
