...
| Metric | Value |
|:-------|:------|
| Native catalog | **4246** skills across 17 active categories, including architecture, design, security, DevOps, AI-engineering, and imported native intake |
| Curated output | **1199** enhanced English derivatives in `skills_omni/` |
