...
| Metric | Value |
|:-------|:------|
| Native catalog | **4669** skills across 17 active categories, including architecture, design, security, DevOps, AI-engineering, and imported native intake |
| Curated output | **1622** enhanced English derivatives in `skills_omni/` |
