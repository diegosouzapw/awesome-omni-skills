...
| Status | Details |
|:-------|:--------|
| ✅ **Available now** | 148 native catalog skills across design, architecture, debugging, docs, OSS, security, DevOps, AI-engineering, data, tools, and machine-learning workflows |
...
| 🧪 **Validation mix** | 116 native skills pass cleanly today, and 32 remain intentionally warning-grade in the permissive intake surface |
