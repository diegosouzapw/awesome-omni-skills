...
| Status | Details |
|:-------|:--------|
| ✅ **Available now** | 723 native catalog skills across design, architecture, debugging, docs, OSS, security, DevOps, AI-engineering, data, tools, and machine-learning workflows |
...
| 🧪 **Validation mix** | 614 native skills pass cleanly today, and 109 remain intentionally warning-grade in the permissive intake surface |
