...
| Status | Details |
|:-------|:--------|
| ✅ **Available now** | 1584 native catalog skills across design, architecture, debugging, docs, OSS, security, DevOps, AI-engineering, data, tools, and machine-learning workflows |
...
| 🧪 **Validation mix** | 1361 native skills pass cleanly today, and 223 remain intentionally warning-grade in the permissive intake surface |
