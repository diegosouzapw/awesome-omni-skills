...
| Status | Details |
|:-------|:--------|
| ✅ **Available now** | 873 native catalog skills across design, architecture, debugging, docs, OSS, security, DevOps, AI-engineering, data, tools, and machine-learning workflows |
...
| 🧪 **Validation mix** | 744 native skills pass cleanly today, and 129 remain intentionally warning-grade in the permissive intake surface |
