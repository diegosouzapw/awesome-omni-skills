...
| Status | Details |
|:-------|:--------|
| ✅ **Available now** | 1893 native catalog skills across design, architecture, debugging, docs, OSS, security, DevOps, AI-engineering, data, tools, and machine-learning workflows |
...
| 🧪 **Validation mix** | 1629 native skills pass cleanly today, and 264 remain intentionally warning-grade in the permissive intake surface |
