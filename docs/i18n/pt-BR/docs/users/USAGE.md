...
| Status | Details |
|:-------|:--------|
| ✅ **Available now** | 4028 native catalog skills across design, architecture, debugging, docs, OSS, security, DevOps, AI-engineering, data, tools, and machine-learning workflows |
...
| 🧪 **Validation mix** | 3473 native skills pass cleanly today, and 555 remain intentionally warning-grade in the permissive intake surface |
