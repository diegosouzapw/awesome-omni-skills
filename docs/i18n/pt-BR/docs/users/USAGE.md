...
| Status | Details |
|:-------|:--------|
| ✅ **Available now** | 3058 native catalog skills across design, architecture, debugging, docs, OSS, security, DevOps, AI-engineering, data, tools, and machine-learning workflows |
...
| 🧪 **Validation mix** | 2643 native skills pass cleanly today, and 415 remain intentionally warning-grade in the permissive intake surface |
