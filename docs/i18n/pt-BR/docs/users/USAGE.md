...
| Status | Details |
|:-------|:--------|
| ✅ **Available now** | 568 native catalog skills across design, architecture, debugging, docs, OSS, security, DevOps, AI-engineering, data, tools, and machine-learning workflows |
...
| 🧪 **Validation mix** | 475 native skills pass cleanly today, and 93 remain intentionally warning-grade in the permissive intake surface |
