...
| Status | Details |
|:-------|:--------|
| ✅ **Available now** | 3990 native catalog skills across design, architecture, debugging, docs, OSS, security, DevOps, AI-engineering, data, tools, and machine-learning workflows |
...
| 🧪 **Validation mix** | 3438 native skills pass cleanly today, and 552 remain intentionally warning-grade in the permissive intake surface |
