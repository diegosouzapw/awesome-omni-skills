...
| Status | Details |
|:-------|:--------|
| ✅ **Available now** | 4715 native catalog skills across design, architecture, debugging, docs, OSS, security, DevOps, AI-engineering, data, tools, and machine-learning workflows |
...
| 🧪 **Validation mix** | 4073 native skills pass cleanly today, and 642 remain intentionally warning-grade in the permissive intake surface |
