...
| Status | Details |
|:-------|:--------|
| ✅ **Available now** | 75 native catalog skills across design, architecture, debugging, docs, OSS, security, DevOps, AI-engineering, data, tools, and machine-learning workflows |
...
| 🧪 **Validation mix** | 58 native skills pass cleanly today, and 17 remain intentionally warning-grade in the permissive intake surface |
