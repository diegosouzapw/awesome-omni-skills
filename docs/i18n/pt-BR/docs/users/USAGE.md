...
<!-- generated:i18n-doc: project=awesome-omni-skills; source=docs/users/USAGE.md; version=0.12.5; release=v0.12.5; english_snapshot=2026-04-20T00:00:00+00:00 -->
...
| Status | Details |
|:-------|:--------|
| ✅ **Available now** | 2362 native catalog skills across design, architecture, debugging, docs, OSS, security, DevOps, AI-engineering, data, tools, and machine-learning workflows |
...
| 🧪 **Validation mix** | 2039 native skills pass cleanly today, and 323 remain intentionally warning-grade in the permissive intake surface |
