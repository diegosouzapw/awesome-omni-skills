...
| Status | Details |
|:-------|:--------|
| ✅ **Available now** | 2048 native catalog skills across design, architecture, debugging, docs, OSS, security, DevOps, AI-engineering, data, tools, and machine-learning workflows |
...
| 🧪 **Validation mix** | 1760 native skills pass cleanly today, and 288 remain intentionally warning-grade in the permissive intake surface |
