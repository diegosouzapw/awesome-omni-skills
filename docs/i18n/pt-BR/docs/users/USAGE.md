...
| Status | Details |
|:-------|:--------|
| ✅ **Available now** | 2895 native catalog skills across design, architecture, debugging, docs, OSS, security, DevOps, AI-engineering, data, tools, and machine-learning workflows |
...
| 🧪 **Validation mix** | 2497 native skills pass cleanly today, and 398 remain intentionally warning-grade in the permissive intake surface |
