...
| Status | Details |
|:-------|:--------|
| ✅ **Available now** | 242 native catalog skills across design, architecture, debugging, docs, OSS, security, DevOps, AI-engineering, data, tools, and machine-learning workflows |
...
| 🧪 **Validation mix** | 189 native skills pass cleanly today, and 53 remain intentionally warning-grade in the permissive intake surface |
