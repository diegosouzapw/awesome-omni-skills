...
| Status | Details |
|:-------|:--------|
| ✅ **Available now** | 325 native catalog skills across design, architecture, debugging, docs, OSS, security, DevOps, AI-engineering, data, tools, and machine-learning workflows |
...
| 🧪 **Validation mix** | 260 native skills pass cleanly today, and 65 remain intentionally warning-grade in the permissive intake surface |
