...
<!-- generated:i18n-doc: project=awesome-omni-skills; source=docs/users/USAGE.md; version=0.12.5; release=v0.12.5; english_snapshot=2026-04-17T00:00:00+00:00 -->
...
| Status | Details |
|:-------|:--------|
| ✅ **Available now** | 1793 native catalog skills across design, architecture, debugging, docs, OSS, security, DevOps, AI-engineering, data, tools, and machine-learning workflows |
...
| 🧪 **Validation mix** | 1541 native skills pass cleanly today, and 252 remain intentionally warning-grade in the permissive intake surface |
