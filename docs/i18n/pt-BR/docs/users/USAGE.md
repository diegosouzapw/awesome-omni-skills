...
| Status | Details |
|:-------|:--------|
| ✅ **Available now** | 798 native catalog skills across design, architecture, debugging, docs, OSS, security, DevOps, AI-engineering, data, tools, and machine-learning workflows |
...
| 🧪 **Validation mix** | 683 native skills pass cleanly today, and 115 remain intentionally warning-grade in the permissive intake surface |
