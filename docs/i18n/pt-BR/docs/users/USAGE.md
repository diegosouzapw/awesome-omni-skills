...
| Status | Details |
|:-------|:--------|
| ✅ **Available now** | 3147 native catalog skills across design, architecture, debugging, docs, OSS, security, DevOps, AI-engineering, data, tools, and machine-learning workflows |
| ✨ **Curated surface** | 327 English-only Omni-maintained derivatives in `skills_omni/` |
| 📦 **Bundles** | `essentials`, `full-stack`, `design`, `security`, `devops`, `ai-engineer`, and `oss-maintainer` are fully backed today |
| 🧪 **Validation mix** | 2723 native skills pass cleanly today, and 424 remain intentionally warning-grade in the permissive intake surface |
