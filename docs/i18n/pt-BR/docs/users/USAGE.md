...
| Status | Details |
|:-------|:--------|
| ✅ **Available now** | 2962 native catalog skills across design, architecture, debugging, docs, OSS, security, DevOps, AI-engineering, data, tools, and machine-learning workflows |
...
| 🧪 **Validation mix** | 2559 native skills pass cleanly today, and 403 remain intentionally warning-grade in the permissive intake surface |
