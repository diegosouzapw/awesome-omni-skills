...
| Status | Details |
|:-------|:--------|
| ✅ **Available now** | 4671 native catalog skills across design, architecture, debugging, docs, OSS, security, DevOps, AI-engineering, data, tools, and machine-learning workflows |
...
| 🧪 **Validation mix** | 4037 native skills pass cleanly today, and 634 remain intentionally warning-grade in the permissive intake surface |
