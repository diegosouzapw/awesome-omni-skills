...
| Status | Details |
|:-------|:--------|
| ✅ **Available now** | 1655 native catalog skills across design, architecture, debugging, docs, OSS, security, DevOps, AI-engineering, data, tools, and machine-learning workflows |
...
| 🧪 **Validation mix** | 1419 native skills pass cleanly today, and 236 remain intentionally warning-grade in the permissive intake surface |
