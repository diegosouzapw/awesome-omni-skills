...
| Status | Details |
|:-------|:--------|
| ✅ **Available now** | 2112 native catalog skills across design, architecture, debugging, docs, OSS, security, DevOps, AI-engineering, data, tools, and machine-learning workflows |
...
| 🧪 **Validation mix** | 1825 native skills pass cleanly today, and 287 remain intentionally warning-grade in the permissive intake surface |
