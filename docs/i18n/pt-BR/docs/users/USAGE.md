...
| Status | Details |
|:-------|:--------|
| ✅ **Available now** | 647 native catalog skills across design, architecture, debugging, docs, OSS, security, DevOps, AI-engineering, data, tools, and machine-learning workflows |
...
| 🧪 **Validation mix** | 546 native skills pass cleanly today, and 101 remain intentionally warning-grade in the permissive intake surface |
