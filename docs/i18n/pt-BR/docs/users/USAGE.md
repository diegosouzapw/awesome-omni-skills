...
| Status | Details |
|:-------|:--------|
| ✅ **Available now** | 2860 native catalog skills across design, architecture, debugging, docs, OSS, security, DevOps, AI-engineering, data, tools, and machine-learning workflows |
...
| 🧪 **Validation mix** | 2468 native skills pass cleanly today, and 392 remain intentionally warning-grade in the permissive intake surface |
