...
| Status | Details |
|:-------|:--------|
| ✅ **Available now** | 1157 native catalog skills across design, architecture, debugging, docs, OSS, security, DevOps, AI-engineering, data, tools, and machine-learning workflows |
...
| 🧪 **Validation mix** | 999 native skills pass cleanly today, and 158 remain intentionally warning-grade in the permissive intake surface |
