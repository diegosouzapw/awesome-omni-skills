...
| Status | Details |
|:-------|:--------|
| ✅ **Available now** | 1835 native catalog skills across design, architecture, debugging, docs, OSS, security, DevOps, AI-engineering, data, tools, and machine-learning workflows |
...
| 🧪 **Validation mix** | 1580 native skills pass cleanly today, and 255 remain intentionally warning-grade in the permissive intake surface |
