...
| Status | Details |
|:-------|:--------|
| ✅ **Available now** | 1983 native catalog skills across design, architecture, debugging, docs, OSS, security, DevOps, AI-engineering, data, tools, and machine-learning workflows |
...
| 🧪 **Validation mix** | 1709 native skills pass cleanly today, and 274 remain intentionally warning-grade in the permissive intake surface |
