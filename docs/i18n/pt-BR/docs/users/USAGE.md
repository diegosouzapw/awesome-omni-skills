...
| Status | Details |
|:-------|:--------|
| ✅ **Available now** | 2989 native catalog skills across design, architecture, debugging, docs, OSS, security, DevOps, AI-engineering, data, tools, and machine-learning workflows |
...
| 🧪 **Validation mix** | 2590 native skills pass cleanly today, and 399 remain intentionally warning-grade in the permissive intake surface |
