...
| Status | Details |
|:-------|:--------|
| ✅ **Available now** | 3178 native catalog skills across design, architecture, debugging, docs, OSS, security, DevOps, AI-engineering, data, tools, and machine-learning workflows |
...
| 🧪 **Validation mix** | 2745 native skills pass cleanly today, and 433 remain intentionally warning-grade in the permissive intake surface |
