...
| Status | Details |
|:-------|:--------|
| ✅ **Available now** | 2558 native catalog skills across design, architecture, debugging, docs, OSS, security, DevOps, AI-engineering, data, tools, and machine-learning workflows |
...
| 🧪 **Validation mix** | 2200 native skills pass cleanly today, and 358 remain intentionally warning-grade in the permissive intake surface |
