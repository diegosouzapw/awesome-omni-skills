...
| Status | Details |
|:-------|:--------|
| ✅ **Available now** | 3177 native catalog skills across design, architecture, debugging, docs, OSS, security, DevOps, AI-engineering, data, tools, and machine-learning workflows |
...
| 🧪 **Validation mix** | 2748 native skills pass cleanly today, and 429 remain intentionally warning-grade in the permissive intake surface |
