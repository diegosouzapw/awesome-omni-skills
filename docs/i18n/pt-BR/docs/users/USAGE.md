...
| Status | Details |
|:-------|:--------|
| ✅ **Available now** | 1699 native catalog skills across design, architecture, debugging, docs, OSS, security, DevOps, AI-engineering, data, tools, and machine-learning workflows |
...
| 🧪 **Validation mix** | 1459 native skills pass cleanly today, and 240 remain intentionally warning-grade in the permissive intake surface |
