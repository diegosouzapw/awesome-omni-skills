...
| Status | Details |
|:-------|:--------|
| ✅ **Available now** | 3816 native catalog skills across design, architecture, debugging, docs, OSS, security, DevOps, AI-engineering, data, tools, and machine-learning workflows |
| ✨ **Curated surface** | 806 English-only Omni-maintained derivatives in `skills_omni/` |
| 📦 **Bundles** | `essentials`, `full-stack`, `design`, `security`, `devops`, `ai-engineer`, and `oss-maintainer` are fully backed today |
| 🧪 **Validation mix** | 3289 native skills pass cleanly today, and 527 remain intentionally warning-grade in the permissive intake surface |
