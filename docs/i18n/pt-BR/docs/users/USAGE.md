...
| Status | Details |
|:-------|:--------|
| ✅ **Available now** | 2162 native catalog skills across design, architecture, debugging, docs, OSS, security, DevOps, AI-engineering, data, tools, and machine-learning workflows |
...
| 🧪 **Validation mix** | 1872 native skills pass cleanly today, and 290 remain intentionally warning-grade in the permissive intake surface |
