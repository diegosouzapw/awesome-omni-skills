...
| Status | Details |
|:-------|:--------|
| ✅ **Available now** | 3318 native catalog skills across design, architecture, debugging, docs, OSS, security, DevOps, AI-engineering, data, tools, and machine-learning workflows |
...
| 🧪 **Validation mix** | 2859 native skills pass cleanly today, and 459 remain intentionally warning-grade in the permissive intake surface |
