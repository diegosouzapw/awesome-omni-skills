...
| Status | Details |
|:-------|:--------|
| ✅ **Available now** | 3517 native catalog skills across design, architecture, debugging, docs, OSS, security, DevOps, AI-engineering, data, tools, and machine-learning workflows |
...
| 🧪 **Validation mix** | 3028 native skills pass cleanly today, and 489 remain intentionally warning-grade in the permissive intake surface |
