...
| Status | Details |
|:-------|:--------|
| ✅ **Available now** | 1751 native catalog skills across design, architecture, debugging, docs, OSS, security, DevOps, AI-engineering, data, tools, and machine-learning workflows |
...
| 🧪 **Validation mix** | 1502 native skills pass cleanly today, and 249 remain intentionally warning-grade in the permissive intake surface |
