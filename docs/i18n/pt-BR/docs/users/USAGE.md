...
| Status | Details |
|:-------|:--------|
| ✅ **Available now** | 946 native catalog skills across design, architecture, debugging, docs, OSS, security, DevOps, AI-engineering, data, tools, and machine-learning workflows |
...
| 🧪 **Validation mix** | 808 native skills pass cleanly today, and 138 remain intentionally warning-grade in the permissive intake surface |
