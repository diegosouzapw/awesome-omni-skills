...
| Status | Details |
|:-------|:--------|
| ✅ **Available now** | 3294 native catalog skills across design, architecture, debugging, docs, OSS, security, DevOps, AI-engineering, data, tools, and machine-learning workflows |
...
| 🧪 **Validation mix** | 2840 native skills pass cleanly today, and 454 remain intentionally warning-grade in the permissive intake surface |
