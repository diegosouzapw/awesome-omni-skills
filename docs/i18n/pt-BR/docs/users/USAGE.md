...
| Status | Details |
|:-------|:--------|
| ✅ **Available now** | 3369 native catalog skills across design, architecture, debugging, docs, OSS, security, DevOps, AI-engineering, data, tools, and machine-learning workflows |
...
| 🧪 **Validation mix** | 2900 native skills pass cleanly today, and 469 remain intentionally warning-grade in the permissive intake surface |
