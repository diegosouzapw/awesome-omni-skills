...
| Status | Details |
|:-------|:--------|
| ✅ **Available now** | 2360 native catalog skills across design, architecture, debugging, docs, OSS, security, DevOps, AI-engineering, data, tools, and machine-learning workflows |
...
| 🧪 **Validation mix** | 2038 native skills pass cleanly today, and 322 remain intentionally warning-grade in the permissive intake surface |
