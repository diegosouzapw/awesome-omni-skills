...
| Status | Details |
|:-------|:--------|
| ✅ **Available now** | 4688 native catalog skills across design, architecture, debugging, docs, OSS, security, DevOps, AI-engineering, data, tools, and machine-learning workflows |
...
| 🧪 **Validation mix** | 4050 native skills pass cleanly today, and 638 remain intentionally warning-grade in the permissive intake surface |
