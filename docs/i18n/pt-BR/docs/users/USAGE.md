...
| Status | Details |
|:-------|:--------|
| ✅ **Available now** | 2070 native catalog skills across design, architecture, debugging, docs, OSS, security, DevOps, AI-engineering, data, tools, and machine-learning workflows |
...
| 🧪 **Validation mix** | 1786 native skills pass cleanly today, and 284 remain intentionally warning-grade in the permissive intake surface |
