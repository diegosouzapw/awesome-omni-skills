...
<!-- generated:i18n-doc: project=awesome-omni-skills; source=docs/users/USAGE.md; version=0.12.9; release=v0.12.9; english_snapshot=2026-05-04T00:00:00+00:00 -->
...
| Status | Details |
|:-------|:--------|
| ✅ **Available now** | 4339 native catalog skills across design, architecture, debugging, docs, OSS, security, DevOps, AI-engineering, data, tools, and machine-learning workflows |
| ✨ **Curated surface** | 1292 English-only Omni-maintained derivatives in `skills_omni/` |
| 📦 **Bundles** | `essentials`, `full-stack`, `design`, `security`, `devops`, `ai-engineer`, and `oss-maintainer` are fully backed today |
| 🧪 **Validation mix** | 3749 native skills pass cleanly today, and 590 remain intentionally warning-grade in the permissive intake surface |
