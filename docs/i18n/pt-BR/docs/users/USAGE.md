...
| Status | Details |
|:-------|:--------|
| ✅ **Available now** | 2493 native catalog skills across design, architecture, debugging, docs, OSS, security, DevOps, AI-engineering, data, tools, and machine-learning workflows |
...
| 🧪 **Validation mix** | 2142 native skills pass cleanly today, and 351 remain intentionally warning-grade in the permissive intake surface |
