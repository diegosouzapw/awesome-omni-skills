...
- 148 published native skills, with 74 curated English derivatives maintained separately in `skills_omni/`
...
- current quality spread `89` to `97`
- current best-practices spread `88` to `98`
