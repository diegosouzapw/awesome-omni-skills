...
<!-- generated:i18n-doc: project=awesome-omni-skills; source=docs/specs/SKILL-CLASSIFICATION.md; version=0.11.0; release=v0.11.0; english_snapshot=2026-04-02T00:00:00+00:00 -->
...
- 263 published native skills, with 109 curated English derivatives maintained separately in `skills_omni/`
...
- current quality spread `78` to `100`
- current best-practices spread `81` to `100`
