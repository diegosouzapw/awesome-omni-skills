...
> Translation snapshot for **Awesome Omni Skills** `v0.12.6`.
...
<!-- generated:i18n-doc: project=awesome-omni-skills; source=docs/contributors/QUALITY-BAR.md; version=0.12.6; release=v0.12.6; english_snapshot=2026-04-16T00:00:00+00:00 -->
...
- 1708 published native skills, plus 144 curated English derivatives in `skills_omni/`
- average quality score `88.6`
- average best-practices score `99.5`
- average security score `92.8`
- validation mix `1466` passed, `242` warn, `0` failed
