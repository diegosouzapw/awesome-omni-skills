...
- 2558 published native skills, plus 297 curated English derivatives in `skills_omni/`
- average quality score `88.5`
- average best-practices score `99.1`
- average security score `92.7`
- validation mix `2200` passed, `358` warn, `0` failed
