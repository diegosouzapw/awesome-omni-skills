...
<!-- awesome-omni-skills: version=0.12.1; native_skills=148; curated_skills=74; updated_at=2026-04-14 -->
...
| 📦 **Catalog** | 📌 148 skills | 148 native catalog skills across 13 active categories, with 74 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 148 native skills across 13 active categories, with 116 passing validation cleanly and 32 currently in warning-grade native intake
