...
<!-- awesome-omni-skills: version=0.12.9; native_skills=4029; curated_skills=981; updated_at=2026-05-10 -->
...
| 📦 **Catalog** | 📌 4029 skills | 4029 native catalog skills across 17 active categories, with 981 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 4029 native skills across 17 active categories, with 3474 passing validation cleanly and 555 currently in warning-grade native intake
- curated `skills_omni/` output remains a maintained English-only surface with 981 automation-managed derivatives
