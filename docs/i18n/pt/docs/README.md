...
<!-- awesome-omni-skills: version=0.12.9; native_skills=3990; curated_skills=980; updated_at=2026-04-28 -->
...
| 📦 **Catalog** | 📌 3990 skills | 3990 native catalog skills across 17 active categories, with 980 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 3990 native skills across 17 active categories, with 3438 passing validation cleanly and 552 currently in warning-grade native intake
