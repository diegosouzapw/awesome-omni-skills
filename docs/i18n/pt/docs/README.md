...
<!-- generated:i18n-doc: project=awesome-omni-skills; source=docs/README.md; version=0.12.6; release=v0.12.6; english_snapshot=2026-04-16T00:00:00+00:00 -->
<!-- generated:project-meta:start -->
<!-- awesome-omni-skills: version=0.12.6; native_skills=1708; curated_skills=144; updated_at=2026-04-16 -->
...
| 📦 **Catalog** | 📌 1708 skills | 1708 native catalog skills across 17 active categories, with 144 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- public `v0.12.6` and private `v1.0.0` are the current stable release floor
- the catalog now covers 1708 native skills across 17 active categories, with 1466 passing validation cleanly and 242 currently in warning-grade native intake
