...
<!-- awesome-omni-skills: version=0.12.5; native_skills=2599; curated_skills=297; updated_at=2026-04-25 -->
...
| 📦 **Catalog** | 📌 2599 skills | 2599 native catalog skills across 17 active categories, with 297 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 2599 native skills across 17 active categories, with 2241 passing validation cleanly and 358 currently in warning-grade native intake
