...
<!-- awesome-omni-skills: version=0.12.5; native_skills=2484; curated_skills=295; updated_at=2026-04-23 -->
...
| 📦 **Catalog** | 📌 2484 skills | 2484 native catalog skills across 17 active categories, with 295 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 2484 native skills across 17 active categories, with 2135 passing validation cleanly and 349 currently in warning-grade native intake
- curated `skills_omni/` output remains a maintained English-only surface with 295 automation-managed derivatives
