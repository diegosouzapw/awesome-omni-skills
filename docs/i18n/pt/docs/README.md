...
<!-- awesome-omni-skills: version=0.12.9; native_skills=3133; curated_skills=313; updated_at=2026-04-25 -->
...
| 📦 **Catalog** | 📌 3133 skills | 3133 native catalog skills across 17 active categories, with 313 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 3133 native skills across 17 active categories, with 2710 passing validation cleanly and 423 currently in warning-grade native intake
