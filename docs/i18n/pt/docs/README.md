...
<!-- awesome-omni-skills: version=0.12.9; native_skills=4668; curated_skills=1621; updated_at=2026-05-10 -->
...
| 📦 **Catalog** | 📌 4668 skills | 4668 native catalog skills across 17 active categories, with 1621 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 4668 native skills across 17 active categories, with 4034 passing validation cleanly and 634 currently in warning-grade native intake
- curated `skills_omni/` output remains a maintained English-only surface with 1621 automation-managed derivatives
