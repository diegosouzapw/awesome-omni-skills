...
<!-- awesome-omni-skills: version=0.12.9; native_skills=2495; curated_skills=297; updated_at=2026-04-25 -->
...
| 📦 **Catalog** | 📌 2495 skills | 2495 native catalog skills across 17 active categories, with 297 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 2495 native skills across 17 active categories, with 2144 passing validation cleanly and 351 currently in warning-grade native intake
