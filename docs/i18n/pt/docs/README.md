...
<!-- generated:i18n-doc: project=awesome-omni-skills; source=docs/README.md; version=0.12.4; release=v0.12.4; english_snapshot=2026-04-15T00:00:00+00:00 -->
<!-- generated:project-meta:start -->
<!-- awesome-omni-skills: version=0.12.4; native_skills=1649; curated_skills=139; updated_at=2026-04-15 -->
...
| 📦 **Catalog** | 📌 1649 skills | 1649 native catalog skills across 17 active categories, with 139 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 1649 native skills across 17 active categories, with 1415 passing validation cleanly and 234 currently in warning-grade native intake
- curated `skills_omni/` output remains a maintained English-only surface with 139 automation-managed derivatives
