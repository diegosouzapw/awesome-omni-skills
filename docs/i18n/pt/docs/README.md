...
<!-- awesome-omni-skills: version=0.12.1; native_skills=3047; curated_skills=74; updated_at=2026-04-12 -->
...
| 📦 **Catalog** | 📌 3047 skills | 3047 native catalog skills across 17 active categories, with 74 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 3047 native skills across 17 active categories, with 2635 passing validation cleanly and 412 currently in warning-grade native intake
