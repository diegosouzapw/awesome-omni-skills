...
| 📦 **Catalog** | 📌 2186 skills | 2186 native catalog skills across 17 active categories, with 170 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 2186 native skills across 17 active categories, with 1891 passing validation cleanly and 295 currently in warning-grade native intake
