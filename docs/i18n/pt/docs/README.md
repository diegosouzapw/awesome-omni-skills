...
<!-- generated:i18n-doc: project=awesome-omni-skills; source=docs/README.md; version=0.12.7; release=v0.12.7; english_snapshot=2026-04-23T00:00:00+00:00 -->
<!-- generated:project-meta:start -->
<!-- awesome-omni-skills: version=0.12.7; native_skills=2486; curated_skills=297; updated_at=2026-04-23 -->
...
| 📦 **Catalog** | 📌 2486 skills | 2486 native catalog skills across 17 active categories, with 297 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- public `v0.12.7` and private `v1.0.0` are the current stable release floor
- the catalog now covers 2486 native skills across 17 active categories, with 2136 passing validation cleanly and 350 currently in warning-grade native intake
- curated `skills_omni/` output remains a maintained English-only surface with 297 automation-managed derivatives
