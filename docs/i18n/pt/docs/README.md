...
<!-- awesome-omni-skills: version=0.12.9; native_skills=3163; curated_skills=313; updated_at=2026-04-26 -->
...
| 📦 **Catalog** | 📌 3163 skills | 3163 native catalog skills across 17 active categories, with 313 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 3163 native skills across 17 active categories, with 2735 passing validation cleanly and 428 currently in warning-grade native intake
- curated `skills_omni/` output remains a maintained English-only surface with 313 automation-managed derivatives
