...
<!-- awesome-omni-skills: version=0.12.9; native_skills=3234; curated_skills=354; updated_at=2026-04-26 -->
...
| 📦 **Catalog** | 📌 3234 skills | 3234 native catalog skills across 17 active categories, with 354 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 3234 native skills across 17 active categories, with 2794 passing validation cleanly and 440 currently in warning-grade native intake
- curated `skills_omni/` output remains a maintained English-only surface with 354 automation-managed derivatives
