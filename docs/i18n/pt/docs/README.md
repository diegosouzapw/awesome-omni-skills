...
<!-- generated:i18n-doc: project=awesome-omni-skills; source=docs/README.md; version=0.12.9; release=v0.12.9; english_snapshot=2026-04-28T00:00:00+00:00 -->
<!-- generated:project-meta:start -->
<!-- awesome-omni-skills: version=0.12.9; native_skills=3936; curated_skills=926; updated_at=2026-04-28 -->
...
| 📦 **Catalog** | 📌 3936 skills | 3936 native catalog skills across 17 active categories, with 926 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 3936 native skills across 17 active categories, with 3392 passing validation cleanly and 544 currently in warning-grade native intake
- curated `skills_omni/` output remains a maintained English-only surface with 926 automation-managed derivatives
