...
<!-- awesome-omni-skills: version=0.12.9; native_skills=2558; curated_skills=297; updated_at=2026-04-25 -->
...
| 📦 **Catalog** | 📌 2558 skills | 2558 native catalog skills across 17 active categories, with 297 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 2558 native skills across 17 active categories, with 2200 passing validation cleanly and 358 currently in warning-grade native intake
