...
<!-- generated:i18n-doc: project=awesome-omni-skills; source=docs/README.md; version=0.12.5; release=v0.12.5; english_snapshot=2026-04-22T00:00:00+00:00 -->
<!-- generated:project-meta:start -->
<!-- awesome-omni-skills: version=0.12.5; native_skills=2395; curated_skills=206; updated_at=2026-04-22 -->
...
| 📦 **Catalog** | 📌 2395 skills | 2395 native catalog skills across 17 active categories, with 206 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 2395 native skills across 17 active categories, with 2066 passing validation cleanly and 329 currently in warning-grade native intake
- curated `skills_omni/` output remains a maintained English-only surface with 206 automation-managed derivatives
