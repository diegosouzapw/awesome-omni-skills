...
<!-- awesome-omni-skills: version=0.12.5; native_skills=1898; curated_skills=144; updated_at=2026-04-19 -->
...
| 📦 **Catalog** | 📌 1898 skills | 1898 native catalog skills across 17 active categories, with 144 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 1898 native skills across 17 active categories, with 1634 passing validation cleanly and 264 currently in warning-grade native intake
