...
<!-- awesome-omni-skills: version=0.12.9; native_skills=3204; curated_skills=354; updated_at=2026-04-26 -->
...
| 📦 **Catalog** | 📌 3204 skills | 3204 native catalog skills across 17 active categories, with 354 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 3204 native skills across 17 active categories, with 2770 passing validation cleanly and 434 currently in warning-grade native intake
