...
<!-- awesome-omni-skills: version=0.12.9; native_skills=4474; curated_skills=1427; updated_at=2026-05-10 -->
...
| 📦 **Catalog** | 📌 4474 skills | 4474 native catalog skills across 17 active categories, with 1427 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 4474 native skills across 17 active categories, with 3875 passing validation cleanly and 599 currently in warning-grade native intake
- curated `skills_omni/` output remains a maintained English-only surface with 1427 automation-managed derivatives
