...
<!-- awesome-omni-skills: version=0.12.5; native_skills=1938; curated_skills=144; updated_at=2026-04-16 -->
...
| 📦 **Catalog** | 📌 1938 skills | 1938 native catalog skills across 17 active categories, with 144 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 1938 native skills across 17 active categories, with 1668 passing validation cleanly and 270 currently in warning-grade native intake
