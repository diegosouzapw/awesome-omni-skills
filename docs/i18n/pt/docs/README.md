...
<!-- generated:i18n-doc: project=awesome-omni-skills; source=docs/README.md; version=0.12.9; release=v0.12.9; english_snapshot=2026-04-26T00:00:00+00:00 -->
<!-- generated:project-meta:start -->
<!-- awesome-omni-skills: version=0.12.9; native_skills=3323; curated_skills=413; updated_at=2026-04-26 -->
...
| 📦 **Catalog** | 📌 3323 skills | 3323 native catalog skills across 17 active categories, with 413 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 3323 native skills across 17 active categories, with 2869 passing validation cleanly and 454 currently in warning-grade native intake
- curated `skills_omni/` output remains a maintained English-only surface with 413 automation-managed derivatives
