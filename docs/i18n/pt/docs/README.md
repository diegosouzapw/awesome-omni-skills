...
<!-- awesome-omni-skills: version=0.12.9; native_skills=3438; curated_skills=456; updated_at=2026-04-26 -->
...
| 📦 **Catalog** | 📌 3438 skills | 3438 native catalog skills across 17 active categories, with 456 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 3438 native skills across 17 active categories, with 2962 passing validation cleanly and 476 currently in warning-grade native intake
- curated `skills_omni/` output remains a maintained English-only surface with 456 automation-managed derivatives
