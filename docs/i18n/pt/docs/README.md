...
<!-- awesome-omni-skills: version=0.12.9; native_skills=3352; curated_skills=413; updated_at=2026-04-26 -->
...
| 📦 **Catalog** | 📌 3352 skills | 3352 native catalog skills across 17 active categories, with 413 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 3352 native skills across 17 active categories, with 2889 passing validation cleanly and 463 currently in warning-grade native intake
