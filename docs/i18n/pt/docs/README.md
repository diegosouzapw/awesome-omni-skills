...
<!-- awesome-omni-skills: version=0.12.9; native_skills=3452; curated_skills=470; updated_at=2026-04-26 -->
...
| 📦 **Catalog** | 📌 3452 skills | 3452 native catalog skills across 17 active categories, with 470 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 3452 native skills across 17 active categories, with 2974 passing validation cleanly and 478 currently in warning-grade native intake
