...
<!-- generated:i18n-doc: project=awesome-omni-skills; source=docs/README.md; version=0.12.9; release=v0.12.9; english_snapshot=2026-05-12T00:00:00+00:00 -->
<!-- generated:project-meta:start -->
<!-- awesome-omni-skills: version=0.12.9; native_skills=4669; curated_skills=1622; updated_at=2026-05-12 -->
...
| 📦 **Catalog** | 📌 4669 skills | 4669 native catalog skills across 17 active categories, with 1622 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 4669 native skills across 17 active categories, with 4035 passing validation cleanly and 634 currently in warning-grade native intake
- curated `skills_omni/` output remains a maintained English-only surface with 1622 automation-managed derivatives
