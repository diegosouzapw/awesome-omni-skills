...
<!-- awesome-omni-skills: version=0.12.1; native_skills=325; curated_skills=74; updated_at=2026-04-14 -->
...
| 📦 **Catalog** | 📌 325 skills | 325 native catalog skills across 16 active categories, with 74 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 325 native skills across 16 active categories, with 260 passing validation cleanly and 65 currently in warning-grade native intake
