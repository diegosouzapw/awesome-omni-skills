...
<!-- awesome-omni-skills: version=0.12.9; native_skills=3087; curated_skills=297; updated_at=2026-04-25 -->
...
| 📦 **Catalog** | 📌 3087 skills | 3087 native catalog skills across 17 active categories, with 297 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 3087 native skills across 17 active categories, with 2667 passing validation cleanly and 420 currently in warning-grade native intake
