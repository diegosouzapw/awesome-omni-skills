...
<!-- awesome-omni-skills: version=0.12.5; native_skills=2362; curated_skills=173; updated_at=2026-04-20 -->
...
| 📦 **Catalog** | 📌 2362 skills | 2362 native catalog skills across 17 active categories, with 173 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 2362 native skills across 17 active categories, with 2039 passing validation cleanly and 323 currently in warning-grade native intake
