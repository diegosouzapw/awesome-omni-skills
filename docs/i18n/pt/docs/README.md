...
<!-- awesome-omni-skills: version=0.12.9; native_skills=4688; curated_skills=1623; updated_at=2026-05-17 -->
...
| 📦 **Catalog** | 📌 4688 skills | 4688 native catalog skills across 17 active categories, with 1623 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 4688 native skills across 17 active categories, with 4050 passing validation cleanly and 638 currently in warning-grade native intake
