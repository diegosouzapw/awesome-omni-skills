...
<!-- awesome-omni-skills: version=0.12.5; native_skills=2196; curated_skills=173; updated_at=2026-04-19 -->
...
| 📦 **Catalog** | 📌 2196 skills | 2196 native catalog skills across 17 active categories, with 173 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 2196 native skills across 17 active categories, with 1903 passing validation cleanly and 293 currently in warning-grade native intake
- curated `skills_omni/` output remains a maintained English-only surface with 173 automation-managed derivatives
