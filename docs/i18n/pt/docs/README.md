...
<!-- awesome-omni-skills: version=0.12.9; native_skills=3147; curated_skills=327; updated_at=2026-04-26 -->
...
| 📦 **Catalog** | 📌 3147 skills | 3147 native catalog skills across 17 active categories, with 327 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 3147 native skills across 17 active categories, with 2723 passing validation cleanly and 424 currently in warning-grade native intake
