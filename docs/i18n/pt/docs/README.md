...
| 📦 **Catalog** | 📌 2165 skills | 2165 native catalog skills across 17 active categories, with 144 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 2165 native skills across 17 active categories, with 1875 passing validation cleanly and 290 currently in warning-grade native intake
