...
<!-- awesome-omni-skills: version=0.12.9; native_skills=3391; curated_skills=430; updated_at=2026-04-26 -->
...
| 📦 **Catalog** | 📌 3391 skills | 3391 native catalog skills across 17 active categories, with 430 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 3391 native skills across 17 active categories, with 2921 passing validation cleanly and 470 currently in warning-grade native intake
