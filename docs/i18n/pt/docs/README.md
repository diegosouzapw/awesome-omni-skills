...
<!-- awesome-omni-skills: version=0.12.1; native_skills=74; curated_skills=0; updated_at=2026-04-14 -->
...
| 📦 **Catalog** | 📌 74 skills | 74 native catalog skills across 13 active categories, with 0 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 74 native skills across 13 active categories, with 58 passing validation cleanly and 16 currently in warning-grade native intake
