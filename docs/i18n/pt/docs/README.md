...
<!-- awesome-omni-skills: version=0.12.5; native_skills=1751; curated_skills=144; updated_at=2026-04-16 -->
...
| 📦 **Catalog** | 📌 1751 skills | 1751 native catalog skills across 17 active categories, with 144 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 1751 native skills across 17 active categories, with 1502 passing validation cleanly and 249 currently in warning-grade native intake
