...
<!-- awesome-omni-skills: version=0.12.1; native_skills=75; curated_skills=1; updated_at=2026-04-12 -->
...
| 📦 **Catalog** | 📌 75 skills | 75 native catalog skills across 13 active categories, with 1 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 75 native skills across 13 active categories, with 58 passing validation cleanly and 17 currently in warning-grade native intake
