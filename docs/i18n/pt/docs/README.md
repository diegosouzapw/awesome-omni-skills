...
<!-- generated:i18n-doc: project=awesome-omni-skills; source=docs/README.md; version=0.12.9; release=v0.12.9; english_snapshot=2026-05-04T00:00:00+00:00 -->
<!-- generated:project-meta:start -->
<!-- awesome-omni-skills: version=0.12.9; native_skills=4178; curated_skills=1131; updated_at=2026-05-04 -->
...
| 📦 **Catalog** | 📌 4178 skills | 4178 native catalog skills across 17 active categories, with 1131 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 4178 native skills across 17 active categories, with 3605 passing validation cleanly and 573 currently in warning-grade native intake
- curated `skills_omni/` output remains a maintained English-only surface with 1131 automation-managed derivatives
