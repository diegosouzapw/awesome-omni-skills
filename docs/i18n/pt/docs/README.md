...
<!-- awesome-omni-skills: version=0.12.9; native_skills=4027; curated_skills=980; updated_at=2026-04-28 -->
...
| 📦 **Catalog** | 📌 4027 skills | 4027 native catalog skills across 17 active categories, with 980 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 4027 native skills across 17 active categories, with 3472 passing validation cleanly and 555 currently in warning-grade native intake
- curated `skills_omni/` output remains a maintained English-only surface with 980 automation-managed derivatives
