...
<!-- awesome-omni-skills: version=0.12.5; native_skills=1849; curated_skills=144; updated_at=2026-04-19 -->
...
| 📦 **Catalog** | 📌 1849 skills | 1849 native catalog skills across 17 active categories, with 144 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 1849 native skills across 17 active categories, with 1594 passing validation cleanly and 255 currently in warning-grade native intake
