...
<!-- awesome-omni-skills: version=0.12.5; native_skills=2191; curated_skills=171; updated_at=2026-04-19 -->
...
| 📦 **Catalog** | 📌 2191 skills | 2191 native catalog skills across 17 active categories, with 171 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 2191 native skills across 17 active categories, with 1896 passing validation cleanly and 295 currently in warning-grade native intake
- curated `skills_omni/` output remains a maintained English-only surface with 171 automation-managed derivatives
