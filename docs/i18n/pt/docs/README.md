...
<!-- awesome-omni-skills: version=0.12.5; native_skills=3058; curated_skills=297; updated_at=2026-04-25 -->
...
| 📦 **Catalog** | 📌 3058 skills | 3058 native catalog skills across 17 active categories, with 297 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 3058 native skills across 17 active categories, with 2643 passing validation cleanly and 415 currently in warning-grade native intake
