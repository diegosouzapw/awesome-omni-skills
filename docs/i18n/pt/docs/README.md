...
<!-- awesome-omni-skills: version=0.12.9; native_skills=4028; curated_skills=980; updated_at=2026-05-10 -->
...
| 📦 **Catalog** | 📌 4028 skills | 4028 native catalog skills across 17 active categories, with 980 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 4028 native skills across 17 active categories, with 3473 passing validation cleanly and 555 currently in warning-grade native intake
