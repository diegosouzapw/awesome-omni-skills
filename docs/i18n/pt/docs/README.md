...
<!-- awesome-omni-skills: version=0.12.1; native_skills=723; curated_skills=74; updated_at=2026-04-14 -->
...
| 📦 **Catalog** | 📌 723 skills | 723 native catalog skills across 17 active categories, with 74 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 723 native skills across 17 active categories, with 614 passing validation cleanly and 109 currently in warning-grade native intake
