...
<!-- awesome-omni-skills: version=0.12.9; native_skills=4556; curated_skills=1509; updated_at=2026-05-10 -->
...
| 📦 **Catalog** | 📌 4556 skills | 4556 native catalog skills across 17 active categories, with 1509 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 4556 native skills across 17 active categories, with 3943 passing validation cleanly and 613 currently in warning-grade native intake
- curated `skills_omni/` output remains a maintained English-only surface with 1509 automation-managed derivatives
