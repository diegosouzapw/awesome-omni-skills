...
<!-- awesome-omni-skills: version=0.12.9; native_skills=4671; curated_skills=1623; updated_at=2026-05-12 -->
...
| 📦 **Catalog** | 📌 4671 skills | 4671 native catalog skills across 17 active categories, with 1623 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 4671 native skills across 17 active categories, with 4037 passing validation cleanly and 634 currently in warning-grade native intake
