...
<!-- generated:i18n-doc: project=awesome-omni-skills; source=docs/README.md; version=0.12.3; release=v0.12.3; english_snapshot=2026-04-15T00:00:00+00:00 -->
<!-- generated:project-meta:start -->
<!-- awesome-omni-skills: version=0.12.3; native_skills=1584; curated_skills=74; updated_at=2026-04-15 -->
...
| 📦 **Catalog** | 📌 1584 skills | 1584 native catalog skills across 17 active categories, with 74 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- public `v0.12.3` and private `v1.0.0` are the current stable release floor
- the catalog now covers 1584 native skills across 17 active categories, with 1361 passing validation cleanly and 223 currently in warning-grade native intake
