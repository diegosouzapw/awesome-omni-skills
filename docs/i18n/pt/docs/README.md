...
<!-- awesome-omni-skills: version=0.12.9; native_skills=4246; curated_skills=1199; updated_at=2026-05-04 -->
...
| 📦 **Catalog** | 📌 4246 skills | 4246 native catalog skills across 17 active categories, with 1199 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 4246 native skills across 17 active categories, with 3666 passing validation cleanly and 580 currently in warning-grade native intake
- curated `skills_omni/` output remains a maintained English-only surface with 1199 automation-managed derivatives
