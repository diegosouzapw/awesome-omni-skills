...
<!-- awesome-omni-skills: version=0.12.5; native_skills=2000; curated_skills=144; updated_at=2026-04-19 -->
...
| 📦 **Catalog** | 📌 2000 skills | 2000 native catalog skills across 17 active categories, with 144 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 2000 native skills across 17 active categories, with 1718 passing validation cleanly and 282 currently in warning-grade native intake
