...
| 📦 **Catalog** | 📌 1839 skills | 1839 native catalog skills across 17 active categories, with 144 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 1839 native skills across 17 active categories, with 1584 passing validation cleanly and 255 currently in warning-grade native intake
