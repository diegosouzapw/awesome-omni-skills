...
<!-- generated:i18n-doc: project=awesome-omni-skills; source=docs/README.md; version=0.12.9; release=v0.12.9; english_snapshot=2026-05-10T00:00:00+00:00 -->
<!-- generated:project-meta:start -->
<!-- awesome-omni-skills: version=0.12.9; native_skills=4603; curated_skills=1556; updated_at=2026-05-10 -->
...
| 📦 **Catalog** | 📌 4603 skills | 4603 native catalog skills across 17 active categories, with 1556 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 4603 native skills across 17 active categories, with 3981 passing validation cleanly and 622 currently in warning-grade native intake
- curated `skills_omni/` output remains a maintained English-only surface with 1556 automation-managed derivatives
