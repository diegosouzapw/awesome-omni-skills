...
<!-- awesome-omni-skills: version=0.12.1; native_skills=242; curated_skills=74; updated_at=2026-04-14 -->
...
| 📦 **Catalog** | 📌 242 skills | 242 native catalog skills across 15 active categories, with 74 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 242 native skills across 15 active categories, with 189 passing validation cleanly and 53 currently in warning-grade native intake
