...
| 📦 **Catalog** | 📌 1841 skills | 1841 native catalog skills across 17 active categories, with 144 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 1841 native skills across 17 active categories, with 1586 passing validation cleanly and 255 currently in warning-grade native intake
