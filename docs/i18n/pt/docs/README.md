...
| 📦 **Catalog** | 📌 2158 skills | 2158 native catalog skills across 17 active categories, with 144 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 2158 native skills across 17 active categories, with 1868 passing validation cleanly and 290 currently in warning-grade native intake
