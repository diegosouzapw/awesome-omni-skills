...
<!-- awesome-omni-skills: version=0.12.9; native_skills=3177; curated_skills=327; updated_at=2026-04-26 -->
...
| 📦 **Catalog** | 📌 3177 skills | 3177 native catalog skills across 17 active categories, with 327 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 3177 native skills across 17 active categories, with 2748 passing validation cleanly and 429 currently in warning-grade native intake
- curated `skills_omni/` output remains a maintained English-only surface with 327 automation-managed derivatives
