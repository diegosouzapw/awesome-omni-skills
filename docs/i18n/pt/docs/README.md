...
<!-- awesome-omni-skills: version=0.12.9; native_skills=3876; curated_skills=866; updated_at=2026-04-28 -->
...
| 📦 **Catalog** | 📌 3876 skills | 3876 native catalog skills across 17 active categories, with 866 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 3876 native skills across 17 active categories, with 3340 passing validation cleanly and 536 currently in warning-grade native intake
- curated `skills_omni/` output remains a maintained English-only surface with 866 automation-managed derivatives
