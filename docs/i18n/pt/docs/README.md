...
<!-- awesome-omni-skills: version=0.12.1; native_skills=2989; curated_skills=0; updated_at=2026-04-13 -->
...
| 📦 **Catalog** | 📌 2989 skills | 2989 native catalog skills across 17 active categories, with 0 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 2989 native skills across 17 active categories, with 2590 passing validation cleanly and 399 currently in warning-grade native intake
