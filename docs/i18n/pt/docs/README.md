...
<!-- awesome-omni-skills: version=0.12.5; native_skills=2715; curated_skills=297; updated_at=2026-04-25 -->
...
| 📦 **Catalog** | 📌 2715 skills | 2715 native catalog skills across 17 active categories, with 297 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 2715 native skills across 17 active categories, with 2337 passing validation cleanly and 378 currently in warning-grade native intake
