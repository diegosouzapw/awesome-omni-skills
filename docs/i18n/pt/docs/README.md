...
<!-- awesome-omni-skills: version=0.12.5; native_skills=3237; curated_skills=297; updated_at=2026-04-25 -->
...
| 📦 **Catalog** | 📌 3237 skills | 3237 native catalog skills across 17 active categories, with 297 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 3237 native skills across 17 active categories, with 2791 passing validation cleanly and 446 currently in warning-grade native intake
