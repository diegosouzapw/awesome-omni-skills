...
<!-- awesome-omni-skills: version=0.12.5; native_skills=2198; curated_skills=173; updated_at=2026-04-19 -->
...
| 📦 **Catalog** | 📌 2198 skills | 2198 native catalog skills across 17 active categories, with 173 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 2198 native skills across 17 active categories, with 1904 passing validation cleanly and 294 currently in warning-grade native intake
