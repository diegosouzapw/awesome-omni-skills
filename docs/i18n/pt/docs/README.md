...
<!-- awesome-omni-skills: version=0.12.5; native_skills=2490; curated_skills=297; updated_at=2026-04-24 -->
...
| 📦 **Catalog** | 📌 2490 skills | 2490 native catalog skills across 17 active categories, with 297 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 2490 native skills across 17 active categories, with 2140 passing validation cleanly and 350 currently in warning-grade native intake
