...
<!-- awesome-omni-skills: version=0.12.4; native_skills=1654; curated_skills=144; updated_at=2026-04-15 -->
...
| 📦 **Catalog** | 📌 1654 skills | 1654 native catalog skills across 17 active categories, with 144 curated English derivatives in `skills_omni` and 7 fully backed bundles |
