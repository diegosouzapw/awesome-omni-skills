...
<!-- generated:i18n-doc: project=awesome-omni-skills; source=docs/README.md; version=0.12.9; release=v0.12.9; english_snapshot=2026-07-27T00:00:00+00:00 -->
...
| 📦 **Catalog** | 📌 4716 skills | 4716 native catalog skills across 17 active categories, with 1623 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 4716 native skills across 17 active categories, with 4074 passing validation cleanly and 642 currently in warning-grade native intake
