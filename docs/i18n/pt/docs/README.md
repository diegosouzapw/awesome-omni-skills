...
<!-- awesome-omni-skills: version=0.12.1; native_skills=568; curated_skills=74; updated_at=2026-04-14 -->
...
| 📦 **Catalog** | 📌 568 skills | 568 native catalog skills across 17 active categories, with 74 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 568 native skills across 17 active categories, with 475 passing validation cleanly and 93 currently in warning-grade native intake
