...
<!-- awesome-omni-skills: version=0.12.1; native_skills=1350; curated_skills=74; updated_at=2026-04-14 -->
...
| 📦 **Catalog** | 📌 1350 skills | 1350 native catalog skills across 17 active categories, with 74 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 1350 native skills across 17 active categories, with 1169 passing validation cleanly and 181 currently in warning-grade native intake
