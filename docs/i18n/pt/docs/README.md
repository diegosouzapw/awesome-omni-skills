...
<!-- awesome-omni-skills: version=0.12.1; native_skills=2901; curated_skills=1; updated_at=2026-04-12 -->
...
| 📦 **Catalog** | 📌 2901 skills | 2901 native catalog skills across 17 active categories, with 1 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 2901 native skills across 17 active categories, with 2516 passing validation cleanly and 385 currently in warning-grade native intake
