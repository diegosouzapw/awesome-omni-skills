...
<!-- awesome-omni-skills: version=0.12.5; native_skills=3148; curated_skills=297; updated_at=2026-04-25 -->
...
| 📦 **Catalog** | 📌 3148 skills | 3148 native catalog skills across 17 active categories, with 297 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 3148 native skills across 17 active categories, with 2721 passing validation cleanly and 427 currently in warning-grade native intake
