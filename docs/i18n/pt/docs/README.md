...
<!-- awesome-omni-skills: version=0.12.5; native_skills=3088; curated_skills=297; updated_at=2026-04-25 -->
...
| 📦 **Catalog** | 📌 3088 skills | 3088 native catalog skills across 17 active categories, with 297 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 3088 native skills across 17 active categories, with 2668 passing validation cleanly and 420 currently in warning-grade native intake
