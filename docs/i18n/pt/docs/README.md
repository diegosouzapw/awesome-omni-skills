...
<!-- generated:i18n-doc: project=awesome-omni-skills; source=docs/README.md; version=0.12.1; release=v0.12.1; english_snapshot=2026-04-12T00:00:00+00:00 -->
<!-- generated:project-meta:start -->
<!-- awesome-omni-skills: version=0.12.1; native_skills=2974; curated_skills=1; updated_at=2026-04-12 -->
...
| 📦 **Catalog** | 📌 2974 skills | 2974 native catalog skills across 17 active categories, with 1 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 2974 native skills across 17 active categories, with 2574 passing validation cleanly and 400 currently in warning-grade native intake
- curated `skills_omni/` output remains a maintained English-only surface with 1 automation-managed derivatives
