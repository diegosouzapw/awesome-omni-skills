...
<!-- awesome-omni-skills: version=0.12.5; native_skills=1793; curated_skills=144; updated_at=2026-04-17 -->
...
| 📦 **Catalog** | 📌 1793 skills | 1793 native catalog skills across 17 active categories, with 144 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 1793 native skills across 17 active categories, with 1541 passing validation cleanly and 252 currently in warning-grade native intake
