...
<!-- awesome-omni-skills: version=0.12.5; native_skills=2027; curated_skills=144; updated_at=2026-04-16 -->
...
| 📦 **Catalog** | 📌 2027 skills | 2027 native catalog skills across 17 active categories, with 144 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 2027 native skills across 17 active categories, with 1750 passing validation cleanly and 277 currently in warning-grade native intake
