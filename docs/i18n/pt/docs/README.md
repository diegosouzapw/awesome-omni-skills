...
<!-- awesome-omni-skills: version=0.12.5; native_skills=2493; curated_skills=297; updated_at=2026-04-24 -->
...
| 📦 **Catalog** | 📌 2493 skills | 2493 native catalog skills across 17 active categories, with 297 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 2493 native skills across 17 active categories, with 2142 passing validation cleanly and 351 currently in warning-grade native intake
