...
<!-- awesome-omni-skills: version=0.12.5; native_skills=3340; curated_skills=297; updated_at=2026-04-25 -->
...
| 📦 **Catalog** | 📌 3340 skills | 3340 native catalog skills across 17 active categories, with 297 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 3340 native skills across 17 active categories, with 2879 passing validation cleanly and 461 currently in warning-grade native intake
