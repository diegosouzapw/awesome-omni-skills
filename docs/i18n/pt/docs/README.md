...
<!-- awesome-omni-skills: version=0.12.5; native_skills=2112; curated_skills=144; updated_at=2026-04-17 -->
...
| 📦 **Catalog** | 📌 2112 skills | 2112 native catalog skills across 17 active categories, with 144 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 2112 native skills across 17 active categories, with 1825 passing validation cleanly and 287 currently in warning-grade native intake
