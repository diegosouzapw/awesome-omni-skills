...
<!-- generated:i18n-doc: project=awesome-omni-skills; source=docs/README.md; version=0.12.9; release=v0.12.9; english_snapshot=2026-05-17T00:00:00+00:00 -->
<!-- generated:project-meta:start -->
<!-- awesome-omni-skills: version=0.12.9; native_skills=4714; curated_skills=1623; updated_at=2026-05-17 -->
...
| 📦 **Catalog** | 📌 4714 skills | 4714 native catalog skills across 17 active categories, with 1623 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 4714 native skills across 17 active categories, with 4072 passing validation cleanly and 642 currently in warning-grade native intake
- curated `skills_omni/` output remains a maintained English-only surface with 1623 automation-managed derivatives
