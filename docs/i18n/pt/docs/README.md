...
<!-- awesome-omni-skills: version=0.12.9; native_skills=4705; curated_skills=1623; updated_at=2026-05-17 -->
...
| 📦 **Catalog** | 📌 4705 skills | 4705 native catalog skills across 17 active categories, with 1623 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 4705 native skills across 17 active categories, with 4065 passing validation cleanly and 640 currently in warning-grade native intake
