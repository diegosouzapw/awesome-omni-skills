...
<!-- generated:i18n-doc: project=awesome-omni-skills; source=docs/README.md; version=0.12.9; release=v0.12.9; english_snapshot=2026-04-27T00:00:00+00:00 -->
<!-- generated:project-meta:start -->
<!-- awesome-omni-skills: version=0.12.9; native_skills=3480; curated_skills=470; updated_at=2026-04-27 -->
...
| 📦 **Catalog** | 📌 3480 skills | 3480 native catalog skills across 17 active categories, with 470 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 3480 native skills across 17 active categories, with 2994 passing validation cleanly and 486 currently in warning-grade native intake
- curated `skills_omni/` output remains a maintained English-only surface with 470 automation-managed derivatives
