...
<!-- awesome-omni-skills: version=0.12.9; native_skills=3417; curated_skills=456; updated_at=2026-04-26 -->
...
| 📦 **Catalog** | 📌 3417 skills | 3417 native catalog skills across 17 active categories, with 456 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 3417 native skills across 17 active categories, with 2946 passing validation cleanly and 471 currently in warning-grade native intake
