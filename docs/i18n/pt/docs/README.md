...
<!-- awesome-omni-skills: version=0.12.5; native_skills=2929; curated_skills=297; updated_at=2026-04-25 -->
...
| 📦 **Catalog** | 📌 2929 skills | 2929 native catalog skills across 17 active categories, with 297 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 2929 native skills across 17 active categories, with 2527 passing validation cleanly and 402 currently in warning-grade native intake
