...
<!-- awesome-omni-skills: version=0.12.1; native_skills=407; curated_skills=74; updated_at=2026-04-14 -->
...
| 📦 **Catalog** | 📌 407 skills | 407 native catalog skills across 17 active categories, with 74 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 407 native skills across 17 active categories, with 335 passing validation cleanly and 72 currently in warning-grade native intake
