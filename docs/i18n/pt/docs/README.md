...
<!-- awesome-omni-skills: version=0.12.5; native_skills=2360; curated_skills=173; updated_at=2026-04-19 -->
...
| 📦 **Catalog** | 📌 2360 skills | 2360 native catalog skills across 17 active categories, with 173 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 2360 native skills across 17 active categories, with 2038 passing validation cleanly and 322 currently in warning-grade native intake
