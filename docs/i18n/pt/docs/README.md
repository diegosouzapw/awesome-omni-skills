...
<!-- awesome-omni-skills: version=0.12.1; native_skills=1288; curated_skills=74; updated_at=2026-04-14 -->
...
| 📦 **Catalog** | 📌 1288 skills | 1288 native catalog skills across 17 active categories, with 74 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 1288 native skills across 17 active categories, with 1112 passing validation cleanly and 176 currently in warning-grade native intake
