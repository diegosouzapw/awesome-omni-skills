...
<!-- awesome-omni-skills: version=0.12.9; native_skills=3264; curated_skills=384; updated_at=2026-04-26 -->
...
| 📦 **Catalog** | 📌 3264 skills | 3264 native catalog skills across 17 active categories, with 384 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 3264 native skills across 17 active categories, with 2818 passing validation cleanly and 446 currently in warning-grade native intake
- curated `skills_omni/` output remains a maintained English-only surface with 384 automation-managed derivatives
