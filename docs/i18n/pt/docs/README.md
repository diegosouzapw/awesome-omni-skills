...
<!-- awesome-omni-skills: version=0.12.9; native_skills=4339; curated_skills=1292; updated_at=2026-05-04 -->
...
| 📦 **Catalog** | 📌 4339 skills | 4339 native catalog skills across 17 active categories, with 1292 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 4339 native skills across 17 active categories, with 3749 passing validation cleanly and 590 currently in warning-grade native intake
- curated `skills_omni/` output remains a maintained English-only surface with 1292 automation-managed derivatives
