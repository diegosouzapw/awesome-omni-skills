...
<!-- awesome-omni-skills: version=0.12.5; native_skills=2198; curated_skills=198; updated_at=2026-04-19 -->
...
| 📦 **Catalog** | 📌 2198 skills | 2198 native catalog skills across 17 active categories, with 198 curated English derivatives in `skills_omni` and 7 fully backed bundles |
