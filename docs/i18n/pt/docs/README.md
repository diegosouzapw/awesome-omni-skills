...
<!-- awesome-omni-skills: version=0.12.9; native_skills=3369; curated_skills=430; updated_at=2026-04-26 -->
...
| 📦 **Catalog** | 📌 3369 skills | 3369 native catalog skills across 17 active categories, with 430 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 3369 native skills across 17 active categories, with 2900 passing validation cleanly and 469 currently in warning-grade native intake
- curated `skills_omni/` output remains a maintained English-only surface with 430 automation-managed derivatives
