...
<!-- awesome-omni-skills: version=0.12.5; native_skills=2520; curated_skills=297; updated_at=2026-04-24 -->
...
| 📦 **Catalog** | 📌 2520 skills | 2520 native catalog skills across 17 active categories, with 297 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 2520 native skills across 17 active categories, with 2168 passing validation cleanly and 352 currently in warning-grade native intake
