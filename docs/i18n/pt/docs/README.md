...
<!-- awesome-omni-skills: version=0.12.5; native_skills=2052; curated_skills=144; updated_at=2026-04-19 -->
...
| 📦 **Catalog** | 📌 2052 skills | 2052 native catalog skills across 17 active categories, with 144 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 2052 native skills across 17 active categories, with 1764 passing validation cleanly and 288 currently in warning-grade native intake
