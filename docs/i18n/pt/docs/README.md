...
<!-- awesome-omni-skills: version=0.12.1; native_skills=2; curated_skills=1; updated_at=2026-04-12 -->
...
| 📦 **Catalog** | 📌 2 skills | 2 native catalog skills across 1 active categories, with 1 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 2 native skills across 1 active categories, with 0 passing validation cleanly and 2 currently in warning-grade native intake
