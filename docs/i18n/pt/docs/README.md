...
<!-- awesome-omni-skills: version=0.12.9; native_skills=4696; curated_skills=1623; updated_at=2026-05-17 -->
...
| 📦 **Catalog** | 📌 4696 skills | 4696 native catalog skills across 17 active categories, with 1623 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 4696 native skills across 17 active categories, with 4058 passing validation cleanly and 638 currently in warning-grade native intake
