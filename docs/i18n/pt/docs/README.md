...
<!-- awesome-omni-skills: version=0.12.5; native_skills=1906; curated_skills=144; updated_at=2026-04-19 -->
...
| 📦 **Catalog** | 📌 1906 skills | 1906 native catalog skills across 17 active categories, with 144 curated English derivatives in `skills_omni` and 7 fully backed bundles |
...
- the catalog now covers 1906 native skills across 17 active categories, with 1640 passing validation cleanly and 266 currently in warning-grade native intake
