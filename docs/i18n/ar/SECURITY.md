...
>**إذا اكتشفت مشكلة أمنية في Awesome Omni Skills، فلا تفتح مشكلة عامة أولاً.**

يرجى الإبلاغ عبر إحدى هذه القنوات الخاصة:

| قناة | كيف |
|:--------|:----|
| 🔒 استشارات أمنية لـ GitHub | [افتح استشارة خاصة](https://github.com/diegosouzapw/awesome-omni-skills/security/advisories/new) |
...
| المكون | المسار |
|:---------|:-----|
| 🖥️CLI والمثبت | `الحزم/cli/` |
| 📚 وقت تشغيل الكتالوج المشترك | `الحزم/الكتالوج النواة/` |
| 🔌 تثبيت الأهداف | `الحزم/أهداف التثبيت/` |
| ⚙️ بناء البرامج النصية والتحقق من صحتها | `أدوات/برامج نصية/` |
| 📦 تم إنشاء التحف الكتالوج | `ديست/` |
| 🌐 حزم API وMCP وA2A | `الحزم/الخادم-api/` · الحزم/الخادم-mcp/` · الحزم/الخادم-a2a/` |
...
| 🔍 الماسح الضوئي الثابت | يقوم بفحص `SKILL.md` والملفات المجمعة والبرامج النصية المساعدة ويمنع النتائج المهمة من الدخول إلى الكتالوج العام |
| 🦠 إطلاق التحقق من البرامج الضارة | يتم التحقق من الإصدارات المنشورة باستخدام كل من ClamAV وVirusTotal قبل النشر |### 🚫 Hard Content Blocks

لا يقبل المستودع العام المهارات التي تتخطى البوابة الأمنية المهمة. تشمل الحاصرات الصلبة الحالية ما يلي:

- يتم نقل المحتوى البعيد مباشرة إلى تنفيذ الصدفة
- الإرشادات التي تحاول الكشف عن المطالبات أو الأسرار أو سياق وقت التشغيل المخفي

عندما يجد المدقق أحد هذه الأنماط، لا تدخل المهارة إلى الكتالوج العام. في تناول المستودع الخارجي، قد يستمر الأشقاء الصالحون في الاستمرار بينما يتم استبعاد المهارات المحظورة والإبلاغ عنها بشكل منفصل.### 🖥️ Runtime Controls
...
| 🦠 بوابة الماسح المزدوج | يلزم إكمال كل من ClamAV وVirusTotal بشكل نظيف لنشر الإصدار |
...
نظرًا لأن Awesome Omni Skills تقدم مساعدات قابلة للتنفيذ، وأدوات محلية مدركة لنظام الملفات، وكاتبات تكوين خاصة بالعميل، فيجب التعامل مع فئات الثغرات الأمنية هذه على أنها**أولوية عالية**حتى لو ظهرت "محلية فقط":
