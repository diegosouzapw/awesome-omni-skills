...
<!-- generated:i18n-doc: project=awesome-omni-skills; source=README.md; version=0.12.9; release=v0.12.9; english_snapshot=2026-05-10T00:00:00+00:00 -->
...
| | Metric | Value |
|:--|:-------|:------|
| 📦 | **Published Skills** | `4603` native skills across 17 active categories |
...
| 🧪 | **Validation Mix** | `3981` passed · `622` warn · `0` errors |
...
|:-------|:--------------|
| 🧠 Native intake skills | **4603** |
| 📂 Active categories | **17** |
| 📦 Fully backed bundles | **7** |
| ✨ Curated derivatives | **1556** in `skills_omni` |
| 🧪 Validation | **3981 passed / 622 warn / 0 errors** |
| 📋 Release | **v0.12.9** |
