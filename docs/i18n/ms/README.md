...
| | Metric | Value |
|:--|:-------|:------|
| 📦 | **Published Skills** | `2901` native skills across 17 active categories |
...
| 🧪 | **Validation Mix** | `2516` passed · `385` warn · `0` errors |
...
|:-------|:--------------|
| 🧠 Native intake skills | **2901** |
| 📂 Active categories | **17** |
| 📦 Fully backed bundles | **7** |
| ✨ Curated derivatives | **1** in `skills_omni` |
| 🧪 Validation | **2516 passed / 385 warn / 0 errors** |
| 📋 Release | **v0.12.1** |
