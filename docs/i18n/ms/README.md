...
| | Metric | Value |
|:--|:-------|:------|
| 📦 | **Published Skills** | `1089` native skills across 17 active categories |
...
| 🧪 | **Validation Mix** | `938` passed · `151` warn · `0` errors |
...
|:-------|:--------------|
| 🧠 Native intake skills | **1089** |
| 📂 Active categories | **17** |
| 📦 Fully backed bundles | **7** |
| ✨ Curated derivatives | **74** in `skills_omni` |
| 🧪 Validation | **938 passed / 151 warn / 0 errors** |
| 📋 Release | **v0.12.1** |
