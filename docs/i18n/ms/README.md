...
| | Metric | Value |
|:--|:-------|:------|
| 📦 | **Published Skills** | `3452` native skills across 17 active categories |
...
| 🧪 | **Validation Mix** | `2974` passed · `478` warn · `0` errors |
...
|:-------|:--------------|
| 🧠 Native intake skills | **3452** |
| 📂 Active categories | **17** |
| 📦 Fully backed bundles | **7** |
| ✨ Curated derivatives | **470** in `skills_omni` |
| 🧪 Validation | **2974 passed / 478 warn / 0 errors** |
| 📋 Release | **v0.12.9** |
