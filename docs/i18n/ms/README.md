...
| | Metric | Value |
|:--|:-------|:------|
| 📦 | **Published Skills** | `4669` native skills across 17 active categories |
...
| 🧪 | **Validation Mix** | `4035` passed · `634` warn · `0` errors |
...
|:-------|:--------------|
| 🧠 Native intake skills | **4669** |
| 📂 Active categories | **17** |
| 📦 Fully backed bundles | **7** |
| ✨ Curated derivatives | **1622** in `skills_omni` |
| 🧪 Validation | **4035 passed / 634 warn / 0 errors** |
| 📋 Release | **v0.12.9** |
