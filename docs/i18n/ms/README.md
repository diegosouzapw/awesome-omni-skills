...
| | Metric | Value |
|:--|:-------|:------|
| 📦 | **Published Skills** | `3323` native skills across 17 active categories |
...
| 🧪 | **Validation Mix** | `2869` passed · `454` warn · `0` errors |
...
|:-------|:--------------|
| 🧠 Native intake skills | **3323** |
| 📂 Active categories | **17** |
| 📦 Fully backed bundles | **7** |
| ✨ Curated derivatives | **413** in `skills_omni` |
| 🧪 Validation | **2869 passed / 454 warn / 0 errors** |
| 📋 Release | **v0.12.9** |
