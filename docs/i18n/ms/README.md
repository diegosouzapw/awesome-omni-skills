...
| | Metric | Value |
|:--|:-------|:------|
| 📦 | **Published Skills** | `647` native skills across 17 active categories |
...
| 🧪 | **Validation Mix** | `546` passed · `101` warn · `0` errors |
...
|:-------|:--------------|
| 🧠 Native intake skills | **647** |
| 📂 Active categories | **17** |
| 📦 Fully backed bundles | **7** |
| ✨ Curated derivatives | **74** in `skills_omni` |
| 🧪 Validation | **546 passed / 101 warn / 0 errors** |
| 📋 Release | **v0.12.1** |
