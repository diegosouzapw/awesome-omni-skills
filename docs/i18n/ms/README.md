...
<!-- generated:i18n-doc: project=awesome-omni-skills; source=README.md; version=0.12.5; release=v0.12.5; english_snapshot=2026-04-18T00:00:00+00:00 -->
<!-- generated:project-meta:start -->
<!-- awesome-omni-skills: version=0.12.5; native_skills=2186; curated_skills=170; updated_at=2026-04-18 -->
...
| | Metric | Value |
|:--|:-------|:------|
| 📦 | **Published Skills** | `2186` native skills across 17 active categories |
...
| 🧪 | **Validation Mix** | `1891` passed · `295` warn · `0` errors |
...
|:-------|:--------------|
| 🧠 Native intake skills | **2186** |
| 📂 Active categories | **17** |
| 📦 Fully backed bundles | **7** |
| ✨ Curated derivatives | **170** in `skills_omni` |
| 🧪 Validation | **1891 passed / 295 warn / 0 errors** |
| 📋 Release | **v0.12.5** |
