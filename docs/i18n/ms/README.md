...
<!-- generated:i18n-doc: project=awesome-omni-skills; source=README.md; version=0.12.9; release=v0.12.9; english_snapshot=2026-05-04T00:00:00+00:00 -->
...
| | Metric | Value |
|:--|:-------|:------|
| 📦 | **Published Skills** | `4178` native skills across 17 active categories |
...
| 🧪 | **Validation Mix** | `3605` passed · `573` warn · `0` errors |
...
|:-------|:--------------|
| 🧠 Native intake skills | **4178** |
| 📂 Active categories | **17** |
| 📦 Fully backed bundles | **7** |
| ✨ Curated derivatives | **1131** in `skills_omni` |
| 🧪 Validation | **3605 passed / 573 warn / 0 errors** |
| 📋 Release | **v0.12.9** |
