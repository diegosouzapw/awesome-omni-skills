# 🧠 Awesome Omni Skills (Bahasa Melayu)
...
<!-- generated:i18n-doc: project=awesome-omni-skills; source=README.md; version=0.12.9; release=v0.12.9; english_snapshot=2026-07-27T00:00:00+00:00 -->
<!-- generated:project-meta:start -->
<!-- awesome-omni-skills: version=0.12.9; native_skills=4716; curated_skills=1623; updated_at=2026-07-27 -->
...
<p align="center">
  ...
  · <a href="README.md">🇲🇾 Bahasa Melayu</a>
  ...
  · <a href="../pt/README.md">🇵🇹 Português (Portugal)</a>
...
| | Metric | Value |
|:--|:-------|:------|
| 📦 | **Published Skills** | `4716` native skills across 17 active categories |
...
| 🧪 | **Validation Mix** | `4074` passed · `642` warn · `0` errors |
...
|:-------|:--------------|
| 🧠 Native intake skills | **4716** |
| 📂 Active categories | **17** |
| 📦 Fully backed bundles | **7** |
| ✨ Curated derivatives | **1623** in `skills_omni` |
| 🧪 Validation | **4074 passed / 642 warn / 0 errors** |
| 📋 Release | **v0.12.9** |
...
| Doc | What You'll Learn |
|:----|:-----------------|
| 🏛️ [Architecture & System Overview](../../ARCHITECTURE.md) | End-to-end map of all functionality, how the surfaces connect, and current state |
| 🗂️ [Project Structure](../../PROJECT-STRUCTURE.md) | The monorepo directory and file reference, and where each runtime lives |
