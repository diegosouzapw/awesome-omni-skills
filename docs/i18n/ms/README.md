...
<!-- generated:i18n-doc: project=awesome-omni-skills; source=README.md; version=0.12.1; release=v0.12.1; english_snapshot=2026-04-14T00:00:00+00:00 -->
...
| | Metric | Value |
|:--|:-------|:------|
| 📦 | **Published Skills** | `1224` native skills across 17 active categories |
...
| 🧪 | **Validation Mix** | `1055` passed · `169` warn · `0` errors |
...
|:-------|:--------------|
| 🧠 Native intake skills | **1224** |
| 📂 Active categories | **17** |
| 📦 Fully backed bundles | **7** |
| ✨ Curated derivatives | **74** in `skills_omni` |
| 🧪 Validation | **1055 passed / 169 warn / 0 errors** |
| 📋 Release | **v0.12.1** |
