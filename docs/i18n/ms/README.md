...
| | Metric | Value |
|:--|:-------|:------|
| 📦 | **Published Skills** | `4668` native skills across 17 active categories |
...
| 🧪 | **Validation Mix** | `4034` passed · `634` warn · `0` errors |
...
|:-------|:--------------|
| 🧠 Native intake skills | **4668** |
| 📂 Active categories | **17** |
| 📦 Fully backed bundles | **7** |
| ✨ Curated derivatives | **1621** in `skills_omni` |
| 🧪 Validation | **4034 passed / 634 warn / 0 errors** |
| 📋 Release | **v0.12.9** |
