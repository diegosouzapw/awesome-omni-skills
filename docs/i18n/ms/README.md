...
| | Metric | Value |
|:--|:-------|:------|
| 📦 | **Published Skills** | `3517` native skills across 17 active categories |
...
| 🧪 | **Validation Mix** | `3028` passed · `489` warn · `0` errors |
...
|:-------|:--------------|
| 🧠 Native intake skills | **3517** |
| 📂 Active categories | **17** |
| 📦 Fully backed bundles | **7** |
| ✨ Curated derivatives | **470** in `skills_omni` |
| 🧪 Validation | **3028 passed / 489 warn / 0 errors** |
| 📋 Release | **v0.12.9** |
