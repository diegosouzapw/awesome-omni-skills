...
| | Metric | Value |
|:--|:-------|:------|
| 📦 | **Published Skills** | `2490` native skills across 17 active categories |
...
| 🧪 | **Validation Mix** | `2140` passed · `350` warn · `0` errors |
...
|:-------|:--------------|
| 🧠 Native intake skills | **2490** |
| 📂 Active categories | **17** |
| 📦 Fully backed bundles | **7** |
| ✨ Curated derivatives | **297** in `skills_omni` |
| 🧪 Validation | **2140 passed / 350 warn / 0 errors** |
| 📋 Release | **v0.12.5** |
