...
| | Metric | Value |
|:--|:-------|:------|
| 📦 | **Published Skills** | `3438` native skills across 17 active categories |
...
| 🧪 | **Validation Mix** | `2962` passed · `476` warn · `0` errors |
...
|:-------|:--------------|
| 🧠 Native intake skills | **3438** |
| 📂 Active categories | **17** |
| 📦 Fully backed bundles | **7** |
| ✨ Curated derivatives | **456** in `skills_omni` |
| 🧪 Validation | **2962 passed / 476 warn / 0 errors** |
| 📋 Release | **v0.12.9** |
