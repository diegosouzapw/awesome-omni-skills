...
| | Metric | Value |
|:--|:-------|:------|
| 📦 | **Published Skills** | `3990` native skills across 17 active categories |
...
| 🧪 | **Validation Mix** | `3438` passed · `552` warn · `0` errors |
...
|:-------|:--------------|
| 🧠 Native intake skills | **3990** |
| 📂 Active categories | **17** |
| 📦 Fully backed bundles | **7** |
| ✨ Curated derivatives | **980** in `skills_omni` |
| 🧪 Validation | **3438 passed / 552 warn / 0 errors** |
| 📋 Release | **v0.12.9** |
