...
| | Metric | Value |
|:--|:-------|:------|
| 📦 | **Published Skills** | `4556` native skills across 17 active categories |
...
| 🧪 | **Validation Mix** | `3943` passed · `613` warn · `0` errors |
...
|:-------|:--------------|
| 🧠 Native intake skills | **4556** |
| 📂 Active categories | **17** |
| 📦 Fully backed bundles | **7** |
| ✨ Curated derivatives | **1509** in `skills_omni` |
| 🧪 Validation | **3943 passed / 613 warn / 0 errors** |
| 📋 Release | **v0.12.9** |
