...
| | Metric | Value |
|:--|:-------|:------|
| 📦 | **Published Skills** | `723` native skills across 17 active categories |
...
| 🧪 | **Validation Mix** | `614` passed · `109` warn · `0` errors |
...
|:-------|:--------------|
| 🧠 Native intake skills | **723** |
| 📂 Active categories | **17** |
| 📦 Fully backed bundles | **7** |
| ✨ Curated derivatives | **74** in `skills_omni` |
| 🧪 Validation | **614 passed / 109 warn / 0 errors** |
| 📋 Release | **v0.12.1** |
