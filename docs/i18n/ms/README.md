...
| | Metric | Value |
|:--|:-------|:------|
| 📦 | **Published Skills** | `407` native skills across 17 active categories |
...
| 🧪 | **Validation Mix** | `335` passed · `72` warn · `0` errors |
...
|:-------|:--------------|
| 🧠 Native intake skills | **407** |
| 📂 Active categories | **17** |
| 📦 Fully backed bundles | **7** |
| ✨ Curated derivatives | **74** in `skills_omni` |
| 🧪 Validation | **335 passed / 72 warn / 0 errors** |
| 📋 Release | **v0.12.1** |
