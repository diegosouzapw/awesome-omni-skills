...
| | Metric | Value |
|:--|:-------|:------|
| 📦 | **Published Skills** | `2362` native skills across 17 active categories |
...
| 🧪 | **Validation Mix** | `2039` passed · `323` warn · `0` errors |
...
|:-------|:--------------|
| 🧠 Native intake skills | **2362** |
| 📂 Active categories | **17** |
| 📦 Fully backed bundles | **7** |
| ✨ Curated derivatives | **173** in `skills_omni` |
| 🧪 Validation | **2039 passed / 323 warn / 0 errors** |
| 📋 Release | **v0.12.5** |
