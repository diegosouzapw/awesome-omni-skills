...
| | Metric | Value |
|:--|:-------|:------|
| 📦 | **Published Skills** | `3204` native skills across 17 active categories |
...
| 🧪 | **Validation Mix** | `2770` passed · `434` warn · `0` errors |
...
|:-------|:--------------|
| 🧠 Native intake skills | **3204** |
| 📂 Active categories | **17** |
| 📦 Fully backed bundles | **7** |
| ✨ Curated derivatives | **354** in `skills_omni` |
| 🧪 Validation | **2770 passed / 434 warn / 0 errors** |
| 📋 Release | **v0.12.9** |
