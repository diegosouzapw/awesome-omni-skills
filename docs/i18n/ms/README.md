...
<!-- generated:i18n-doc: project=awesome-omni-skills; source=README.md; version=0.12.6; release=v0.12.6; english_snapshot=2026-04-16T00:00:00+00:00 -->
...
| | Metric | Value |
|:--|:-------|:------|
| 📦 | **Published Skills** | `1708` native skills across 17 active categories |
...
| 🧪 | **Validation Mix** | `1466` passed · `242` warn · `0` errors |
...
|:-------|:--------------|
| 🧠 Native intake skills | **1708** |
| 📂 Active categories | **17** |
| 📦 Fully backed bundles | **7** |
| ✨ Curated derivatives | **144** in `skills_omni` |
| 🧪 Validation | **1466 passed / 242 warn / 0 errors** |
| 📋 Release | **v0.12.6** |
