...
| | Metric | Value |
|:--|:-------|:------|
| 📦 | **Published Skills** | `3264` native skills across 17 active categories |
...
| 🧪 | **Validation Mix** | `2818` passed · `446` warn · `0` errors |
...
|:-------|:--------------|
| 🧠 Native intake skills | **3264** |
| 📂 Active categories | **17** |
| 📦 Fully backed bundles | **7** |
| ✨ Curated derivatives | **384** in `skills_omni` |
| 🧪 Validation | **2818 passed / 446 warn / 0 errors** |
| 📋 Release | **v0.12.9** |
