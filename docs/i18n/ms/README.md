...
| | Metric | Value |
|:--|:-------|:------|
| 📦 | **Published Skills** | `946` native skills across 17 active categories |
...
| 🧪 | **Validation Mix** | `808` passed · `138` warn · `0` errors |
...
|:-------|:--------------|
| 🧠 Native intake skills | **946** |
| 📂 Active categories | **17** |
| 📦 Fully backed bundles | **7** |
| ✨ Curated derivatives | **74** in `skills_omni` |
| 🧪 Validation | **808 passed / 138 warn / 0 errors** |
| 📋 Release | **v0.12.1** |
