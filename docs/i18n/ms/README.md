...
| | Metric | Value |
|:--|:-------|:------|
| 📦 | **Published Skills** | `148` native skills across 13 active categories |
...
| 🧪 | **Validation Mix** | `116` passed · `32` warn · `0` errors |
...
|:-------|:--------------|
| 🧠 Native intake skills | **148** |
| 📂 Active categories | **13** |
| 📦 Fully backed bundles | **7** |
| ✨ Curated derivatives | **74** in `skills_omni` |
| 🧪 Validation | **116 passed / 32 warn / 0 errors** |
| 📋 Release | **v0.12.1** |
