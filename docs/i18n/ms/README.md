...
| | Metric | Value |
|:--|:-------|:------|
| 📦 | **Published Skills** | `4028` native skills across 17 active categories |
...
| 🧪 | **Validation Mix** | `3473` passed · `555` warn · `0` errors |
...
|:-------|:--------------|
| 🧠 Native intake skills | **4028** |
| 📂 Active categories | **17** |
| 📦 Fully backed bundles | **7** |
| ✨ Curated derivatives | **980** in `skills_omni` |
| 🧪 Validation | **3473 passed / 555 warn / 0 errors** |
| 📋 Release | **v0.12.9** |
