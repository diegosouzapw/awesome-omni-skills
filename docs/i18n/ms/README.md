...
| | Metric | Value |
|:--|:-------|:------|
| 📦 | **Published Skills** | `3147` native skills across 17 active categories |
...
| 🧪 | **Validation Mix** | `2723` passed · `424` warn · `0` errors |
...
|:-------|:--------------|
| 🧠 Native intake skills | **3147** |
| 📂 Active categories | **17** |
| 📦 Fully backed bundles | **7** |
| ✨ Curated derivatives | **327** in `skills_omni` |
| 🧪 Validation | **2723 passed / 424 warn / 0 errors** |
| 📋 Release | **v0.12.9** |
