...
| | Metric | Value |
|:--|:-------|:------|
| 📦 | **Published Skills** | `2196` native skills across 17 active categories |
...
| 🧪 | **Validation Mix** | `1903` passed · `293` warn · `0` errors |
...
|:-------|:--------------|
| 🧠 Native intake skills | **2196** |
| 📂 Active categories | **17** |
| 📦 Fully backed bundles | **7** |
| ✨ Curated derivatives | **173** in `skills_omni` |
| 🧪 Validation | **1903 passed / 293 warn / 0 errors** |
| 📋 Release | **v0.12.5** |
