...
| | Metric | Value |
|:--|:-------|:------|
| 📦 | **Published Skills** | `4714` native skills across 17 active categories |
...
| 🧪 | **Validation Mix** | `4072` passed · `642` warn · `0` errors |
...
|:-------|:--------------|
| 🧠 Native intake skills | **4714** |
| 📂 Active categories | **17** |
| 📦 Fully backed bundles | **7** |
| ✨ Curated derivatives | **1623** in `skills_omni` |
| 🧪 Validation | **4072 passed / 642 warn / 0 errors** |
| 📋 Release | **v0.12.9** |
