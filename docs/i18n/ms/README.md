...
| | Metric | Value |
|:--|:-------|:------|
| 📦 | **Published Skills** | `4474` native skills across 17 active categories |
...
| 🧪 | **Validation Mix** | `3875` passed · `599` warn · `0` errors |
...
|:-------|:--------------|
| 🧠 Native intake skills | **4474** |
| 📂 Active categories | **17** |
| 📦 Fully backed bundles | **7** |
| ✨ Curated derivatives | **1427** in `skills_omni` |
| 🧪 Validation | **3875 passed / 599 warn / 0 errors** |
| 📋 Release | **v0.12.9** |
