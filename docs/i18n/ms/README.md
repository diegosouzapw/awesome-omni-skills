...
| | Metric | Value |
|:--|:-------|:------|
| 📦 | **Published Skills** | `1584` native skills across 17 active categories |
...
| 🧪 | **Validation Mix** | `1361` passed · `223` warn · `0` errors |
...
|:-------|:--------------|
| 🧠 Native intake skills | **1584** |
| 📂 Active categories | **17** |
| 📦 Fully backed bundles | **7** |
| ✨ Curated derivatives | **74** in `skills_omni` |
| 🧪 Validation | **1361 passed / 223 warn / 0 errors** |
| 📋 Release | **v0.12.4** |
