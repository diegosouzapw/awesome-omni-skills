...
| | Metric | Value |
|:--|:-------|:------|
| 📦 | **Published Skills** | `3480` native skills across 17 active categories |
...
| 🧪 | **Validation Mix** | `2994` passed · `486` warn · `0` errors |
...
|:-------|:--------------|
| 🧠 Native intake skills | **3480** |
| 📂 Active categories | **17** |
| 📦 Fully backed bundles | **7** |
| ✨ Curated derivatives | **470** in `skills_omni` |
| 🧪 Validation | **2994 passed / 486 warn / 0 errors** |
| 📋 Release | **v0.12.9** |
