...
| | Metric | Value |
|:--|:-------|:------|
| 📦 | **Published Skills** | `4688` native skills across 17 active categories |
...
| 🧪 | **Validation Mix** | `4050` passed · `638` warn · `0` errors |
...
|:-------|:--------------|
| 🧠 Native intake skills | **4688** |
| 📂 Active categories | **17** |
| 📦 Fully backed bundles | **7** |
| ✨ Curated derivatives | **1623** in `skills_omni` |
| 🧪 Validation | **4050 passed / 638 warn / 0 errors** |
| 📋 Release | **v0.12.9** |
