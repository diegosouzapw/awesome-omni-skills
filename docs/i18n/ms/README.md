...
<!-- generated:i18n-doc: project=awesome-omni-skills; source=README.md; version=0.12.5; release=v0.12.5; english_snapshot=2026-04-21T00:00:00+00:00 -->
<!-- generated:project-meta:start -->
<!-- awesome-omni-skills: version=0.12.5; native_skills=2389; curated_skills=200; updated_at=2026-04-21 -->
...
| | Metric | Value |
|:--|:-------|:------|
| 📦 | **Published Skills** | `2389` native skills across 17 active categories |
...
| 🧪 | **Validation Mix** | `2060` passed · `329` warn · `0` errors |
...
|:-------|:--------------|
| 🧠 Native intake skills | **2389** |
| 📂 Active categories | **17** |
| 📦 Fully backed bundles | **7** |
| ✨ Curated derivatives | **200** in `skills_omni` |
| 🧪 Validation | **2060 passed / 329 warn / 0 errors** |
| 📋 Release | **v0.12.5** |
