...
| | Metric | Value |
|:--|:-------|:------|
| 📦 | **Published Skills** | `2989` native skills across 17 active categories |
...
| 🧪 | **Validation Mix** | `2590` passed · `399` warn · `0` errors |
...
|:-------|:--------------|
| 🧠 Native intake skills | **2989** |
| 📂 Active categories | **17** |
| 📦 Fully backed bundles | **7** |
| ✨ Curated derivatives | **0** in `skills_omni` |
| 🧪 Validation | **2590 passed / 399 warn / 0 errors** |
| 📋 Release | **v0.12.1** |
