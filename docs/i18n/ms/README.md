...
<!-- generated:i18n-doc: project=awesome-omni-skills; source=README.md; version=0.12.5; release=v0.12.5; english_snapshot=2026-04-24T00:00:00+00:00 -->
...
| | Metric | Value |
|:--|:-------|:------|
| 📦 | **Published Skills** | `2506` native skills across 17 active categories |
...
| 🧪 | **Validation Mix** | `2155` passed · `351` warn · `0` errors |
...
|:-------|:--------------|
| 🧠 Native intake skills | **2506** |
| 📂 Active categories | **17** |
| 📦 Fully backed bundles | **7** |
| ✨ Curated derivatives | **297** in `skills_omni` |
| 🧪 Validation | **2155 passed / 351 warn / 0 errors** |
| 📋 Release | **v0.12.5** |
