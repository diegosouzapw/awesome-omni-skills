...
<!-- generated:i18n-doc: project=awesome-omni-skills; source=README.md; version=0.12.9; release=v0.12.9; english_snapshot=2026-04-27T00:00:00+00:00 -->
...
| | Metric | Value |
|:--|:-------|:------|
| 📦 | **Published Skills** | `3504` native skills across 17 active categories |
...
| 🧪 | **Validation Mix** | `3016` passed · `488` warn · `0` errors |
...
|:-------|:--------------|
| 🧠 Native intake skills | **3504** |
| 📂 Active categories | **17** |
| 📦 Fully backed bundles | **7** |
| ✨ Curated derivatives | **470** in `skills_omni` |
| 🧪 Validation | **3016 passed / 488 warn / 0 errors** |
| 📋 Release | **v0.12.9** |
