...
<!-- awesome-omni-skills: version=0.12.5; native_skills=2188; curated_skills=170; updated_at=2026-04-18 -->
...
| | Metric | Value |
|:--|:-------|:------|
| 📦 | **Published Skills** | `2188` native skills across 17 active categories |
...
| 🧪 | **Validation Mix** | `1893` passed · `295` warn · `0` errors |
...
|:-------|:--------------|
| 🧠 Native intake skills | **2188** |
| 📂 Active categories | **17** |
| 📦 Fully backed bundles | **7** |
| ✨ Curated derivatives | **170** in `skills_omni` |
| 🧪 Validation | **1893 passed / 295 warn / 0 errors** |
| 📋 Release | **v0.12.5** |
