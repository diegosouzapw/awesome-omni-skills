...
| | Metric | Value |
|:--|:-------|:------|
| 📦 | **Published Skills** | `2052` native skills across 17 active categories |
...
| 🧪 | **Validation Mix** | `1764` passed · `288` warn · `0` errors |
...
|:-------|:--------------|
| 🧠 Native intake skills | **2052** |
| 📂 Active categories | **17** |
| 📦 Fully backed bundles | **7** |
| ✨ Curated derivatives | **144** in `skills_omni` |
| 🧪 Validation | **1764 passed / 288 warn / 0 errors** |
| 📋 Release | **v0.12.5** |
