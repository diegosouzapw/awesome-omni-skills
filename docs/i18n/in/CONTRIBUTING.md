...
>**विस्मयकारी ओमनी कौशल कौशल का एक सार्वजनिक भंडार है, बेहतर सर्वोत्तम अभ्यास डेरिवेटिव का एक क्यूरेटेड भंडार है, और उस कैटलॉग के शीर्ष पर निर्मित रनटाइम सतहें हैं।**
...
| 🔁 भंडार-आधारित सेवन | अनुरक्षक द्वारा संचालित बाहरी आयात अभी भी `कौशल/` के अंतर्गत आते हैं और समान समीक्षा मानक का पालन करते हैं
...
| 📥 रिपॉजिटरी-आधारित इनटेक पीआर की समीक्षा करें | `बाहरी-आयात/<स्रोत>` शाखाएं `कौशल/` को लक्षित करती हैं |
| 🌍 एक नई अपस्ट्रीम रिपॉजिटरी का प्रस्ताव | `Repository-SOURCES.md` |
| 📖 अद्यतन योगदानकर्ता मार्गदर्शन | `दस्तावेज़/योगदानकर्ता/` |
| 🖥️ सीएलआई, इंस्टॉलर या स्क्रिप्ट में सुधार करें | `पैकेज/सीएलआई/` और `टूल्स/स्क्रिप्ट/` |
...
>**💡 टिप:**रिलीज़-ग्रेड कौशल पैक में `एजेंट/`, `संदर्भ/`, `उदाहरण/`, और `स्क्रिप्ट/` शामिल होना चाहिए। लेकिन सेवन सतह जानबूझकर अनुमेय है - न्यूनतम मूल आवक कौशल की अनुमति है, और एन्हांसर पाइपलाइन मजबूत व्युत्पन्न उत्पन्न करती है।### 🔀 Two Native Intake Paths

सार्वजनिक भंडार दो परिचालन पथों के माध्यम से मूल कौशल स्वीकार करता है:

| पथ | यह कैसे आता है | समीक्षा अपेक्षा |
|:----|:----------------------|:-------------------|
| 👤 प्रत्यक्ष योगदानकर्ता पीआर | एक मानव शाखा सीधे `कौशल/` का संपादन करती है | कौशल, उत्पन्न कलाकृतियों और बंडल प्रभाव को मान्य करें |
| 📥 रिपॉजिटरी-आधारित बाहरी सेवन | अनुरक्षक द्वारा संचालित `बाहरी-आयात/<स्रोत>` पीआर किसी अन्य समीक्षा किए गए भंडार से कौशल आयात करता है | कौशल के साथ-साथ उत्पत्ति, अपस्ट्रीम स्वामित्व और लाइसेंस नोट्स को मान्य करें |

दोनों पथ `कौशल/` में उतरते हैं, दोनों एक ही सार्वजनिक सत्यापनकर्ता को ट्रिगर करते हैं, और दोनों एक क्यूरेटेड `skills_omni/` साथी पीआर का उत्पादन कर सकते हैं।

यदि आप किसी कौशल को सीधे भेजने के बजाय एक अपस्ट्रीम रिपॉजिटरी का प्रस्ताव करना चाहते हैं, तो [REPOSITORY-SOURCES.md](REPOSITORY-SOURCES.md) को संपादित करें। सामान्य प्रस्ताव अब रेपो-प्रथम है:

- `repo_url` प्रदान करें
- जब तक आपको गैर-डिफ़ॉल्ट शाखा की आवश्यकता न हो, `शाखा` को `ऑटो` के रूप में छोड़ दें
- `skills_path` को `auto` के रूप में छोड़ दें जब तक कि आपको सटीक रूट न पता हो

मर्ज में अभी भी एक सार्वजनिक समीक्षा गेट है, स्वचालित सिंक ट्रिगर नहीं।### 🌐 Language Policy
...
>**⚠️ महत्वपूर्ण:**सत्यापन सीएलआई, एपीआई, एमसीपी, ए2ए, मैनिफ़ेस्ट, अभिलेखागार और रिलीज़ ऑटोमेशन द्वारा उपयोग किया जाने वाला अनुबंध है। जेनरेट किए गए मेटाडेटा को समीक्षा सतह के हिस्से के रूप में मानें, डिस्पोजेबल आउटपुट के रूप में नहीं।

यदि आप ब्रांडिंग, पैकेज मेटाडेटा, रेपो यूआरएल, या रिपॉजिटरी हेडर कॉपी को छूते हैं, तो भी चलाएं:```bash
npm run repo:metadata:print
```

वह कमांड `data/project_identity.json` से प्राप्त स्रोत-नियंत्रित GitHub विवरण, होमपेज और विषय अनुबंध को प्रिंट करता है।### 📥 Intake Policy
...
यदि आप `पैकेज/सीएलआई/`, `पैकेज/कैटलॉग-कोर/`, `पैकेज/सर्वर-*/` को स्पर्श करते हैं, या स्क्रिप्ट बनाते हैं:
...
| चैनल | लिंक |
|:--------|:-----|
| 💬 प्रश्न | [एक चर्चा खोलें](https://github.com/diegosouzapw/awesome-omni-skills/discussions) |
| 🐛 कीड़े | [एक अंक खोलें](https://github.com/diegosouzapw/awesome-omni-skills/issues) |
| 📝 प्रारंभिक प्रतिक्रिया | [ड्राफ्ट पीआर खोलें](https://github.com/diegosouzapw/awesome-omni-skills/pulls) |