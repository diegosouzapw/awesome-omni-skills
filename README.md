...
👉 **[Complete Getting Started Guide](docs/users/getting-started.md)**
👉 **[Usage Guide](docs/users/usage.md)** — how to invoke skills in each tool
...
👉 **[Full Template](docs/contributors/skill-template.md)** | **[Skill Anatomy](docs/contributors/skill-anatomy.md)**

---

## Curated Bundles

Bundles are recommended skill groups by role. Install once, then pick skills from your bundle.
...
👉 **[Full Bundles Guide](docs/users/bundles.md)**
...
| `CATALOG.md`                 | Auto-generated skill catalog (by category)           |
...
Start with just 3-5 skills from a [bundle](docs/users/bundles.md). You don't need to load all skills at once.
...
👉 **[Full Contributing Guide](CONTRIBUTING.md)** | **[Quality Bar](docs/contributors/quality-bar.md)**
...
| :--------------------------------------------------------------------- | :-------------------------------------------------------------------------------- |
| [Getting Started](docs/users/getting-started.md)                       | [Contributing Guide](CONTRIBUTING.md)                                             |
| [Usage Guide](docs/users/usage.md)                                     | [Skill Template](docs/contributors/skill-template.md)                             |
| [Bundles](docs/users/bundles.md)                                       | [Skill Anatomy](docs/contributors/skill-anatomy.md)                               |
