...
family_id: "ai-pricing"
family_name: "AI Pricing Skill"
variant_id: "omni"
variant_label: "Omni Curated"
is_default_variant: true
derived_from: "skills/ai-pricing"
...
```text
Review @ai-pricing against EXTERNAL_SOURCE.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
