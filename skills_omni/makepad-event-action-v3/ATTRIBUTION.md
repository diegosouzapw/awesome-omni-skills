# Attribution for makepad-event-action-v3
...
- Upstream skill id: `makepad-event-action-v3`
- Upstream title: `Makepad Event/Action Skill`
- Upstream path: `skills/makepad-event-action-v3/`
