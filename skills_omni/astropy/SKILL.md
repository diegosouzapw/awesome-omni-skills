...
derived_from: "skills/astropy"
upstream_skill: "skills/astropy"
...
```text
Review @astropy against EXTERNAL_SOURCE.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
