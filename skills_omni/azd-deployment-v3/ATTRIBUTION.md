# Attribution for azd-deployment-v3
...
- Upstream skill id: `azd-deployment-v3`
- Upstream title: `Azure Developer CLI (azd) Container Apps Deployment`
- Upstream path: `skills/azd-deployment-v3/`
