# Attribution for ask-questions-if-underspecified-v2
...
- Upstream skill id: `ask-questions-if-underspecified-v2`
- Upstream title: `Ask Questions If Underspecified`
- Upstream path: `skills/ask-questions-if-underspecified-v2/`
