# Attribution for stripe-automation-v3
...
- Upstream skill id: `stripe-automation-v3`
- Upstream title: `Stripe Automation via Rube MCP`
- Upstream path: `skills/stripe-automation-v3/`
