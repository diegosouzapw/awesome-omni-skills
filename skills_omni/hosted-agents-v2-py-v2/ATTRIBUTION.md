# Attribution for hosted-agents-v2-py-v2
...
- Upstream skill id: `hosted-agents-v2-py-v2`
- Upstream title: `Azure AI Hosted Agents (Python)`
- Upstream path: `skills/hosted-agents-v2-py-v2/`
