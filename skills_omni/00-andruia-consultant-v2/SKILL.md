...
family_id: "00-andruia-consultant-v2"
family_name: "\ud83e\udd16 Andru.ia Solutions Architect - Hybrid Engine (v2.0)"
variant_id: "omni"
variant_label: "Omni Curated"
is_default_variant: true
derived_from: "skills/00-andruia-consultant-v2"
upstream_skill: "skills/00-andruia-consultant-v2"
...
```text
Review @00-andruia-consultant-v2 against EXTERNAL_SOURCE.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
