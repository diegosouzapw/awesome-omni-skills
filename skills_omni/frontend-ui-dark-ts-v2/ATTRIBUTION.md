# Attribution for frontend-ui-dark-ts-v2
...
- Upstream skill id: `frontend-ui-dark-ts-v2`
- Upstream title: `Frontend UI Dark Theme (TypeScript)`
- Upstream path: `skills/frontend-ui-dark-ts-v2/`
