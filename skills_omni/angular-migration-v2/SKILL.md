...
family_id: "angular-migration-v2"
family_name: "Angular Migration"
variant_id: "omni"
variant_label: "Omni Curated"
is_default_variant: true
derived_from: "skills/angular-migration-v2"
upstream_skill: "skills/angular-migration-v2"
...
```text
Review @angular-migration-v2 against EXTERNAL_SOURCE.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
