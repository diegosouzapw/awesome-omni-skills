# Attribution for azure-keyvault-keys-rust-v2
...
- Upstream skill id: `azure-keyvault-keys-rust-v2`
- Upstream title: `Azure Key Vault Keys SDK for Rust`
- Upstream path: `skills/azure-keyvault-keys-rust-v2/`
