# Attribution for nextjs-app-router-patterns-v3
...
- Upstream skill id: `nextjs-app-router-patterns-v3`
- Upstream title: `Next.js App Router Patterns`
- Upstream path: `skills/nextjs-app-router-patterns-v3/`
