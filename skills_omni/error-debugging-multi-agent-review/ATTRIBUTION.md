# Attribution for error-debugging-multi-agent-review
...
- Upstream skill id: `error-debugging-multi-agent-review`
- Upstream title: `Multi-Agent Code Review Orchestration Tool`
- Upstream path: `skills/error-debugging-multi-agent-review/`
