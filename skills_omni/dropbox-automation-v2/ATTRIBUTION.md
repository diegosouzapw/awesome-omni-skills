# Attribution for dropbox-automation-v2
...
- Upstream skill id: `dropbox-automation-v2`
- Upstream title: `Dropbox Automation via Rube MCP`
- Upstream path: `skills/dropbox-automation-v2/`
