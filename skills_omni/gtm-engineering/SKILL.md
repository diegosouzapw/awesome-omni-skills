...
family_id: "gtm-engineering"
family_name: "GTM Engineering: Automation, Architecture & Agent Orchestration"
variant_id: "omni"
variant_label: "Omni Curated"
is_default_variant: true
derived_from: "skills/gtm-engineering"
upstream_skill: "skills/gtm-engineering"
...
```text
Review @gtm-engineering against EXTERNAL_SOURCE.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
