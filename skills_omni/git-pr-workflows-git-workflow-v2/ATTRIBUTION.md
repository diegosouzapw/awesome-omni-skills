# Attribution for git-pr-workflows-git-workflow-v2
...
- Upstream skill id: `git-pr-workflows-git-workflow-v2`
- Upstream title: `Complete Git Workflow with Multi-Agent Orchestration`
- Upstream path: `skills/git-pr-workflows-git-workflow-v2/`
