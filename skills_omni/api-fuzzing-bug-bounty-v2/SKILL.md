...
family_id: "api-fuzzing-bug-bounty-v2"
family_name: "API Fuzzing for Bug Bounty"
variant_id: "omni"
variant_label: "Omni Curated"
is_default_variant: true
derived_from: "skills/api-fuzzing-bug-bounty-v2"
upstream_skill: "skills/api-fuzzing-bug-bounty-v2"
...
```text
Review @api-fuzzing-bug-bounty-v2 against EXTERNAL_SOURCE.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
