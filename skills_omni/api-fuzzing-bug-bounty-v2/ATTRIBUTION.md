# Attribution for api-fuzzing-bug-bounty-v2
...
- Upstream skill id: `api-fuzzing-bug-bounty-v2`
- Upstream title: `API Fuzzing for Bug Bounty`
- Upstream path: `skills/api-fuzzing-bug-bounty-v2/`
