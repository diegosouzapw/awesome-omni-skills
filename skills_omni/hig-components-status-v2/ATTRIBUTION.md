# Attribution for hig-components-status-v2
...
- Upstream skill id: `hig-components-status-v2`
- Upstream title: `Apple HIG: Status Components`
- Upstream path: `skills/hig-components-status-v2/`
