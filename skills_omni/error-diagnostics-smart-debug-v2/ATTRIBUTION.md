# Attribution for error-diagnostics-smart-debug-v2
...
- Upstream skill id: `error-diagnostics-smart-debug-v2`
- Upstream title: `error-diagnostics-smart-debug`
- Upstream path: `skills/error-diagnostics-smart-debug-v2/`
