...
family_id: "aws-cost-optimizer"
family_name: "AWS Cost Optimizer"
variant_id: "omni"
variant_label: "Omni Curated"
is_default_variant: true
derived_from: "skills/aws-cost-optimizer"
upstream_skill: "skills/aws-cost-optimizer"
...
```text
Review @aws-cost-optimizer against EXTERNAL_SOURCE.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
