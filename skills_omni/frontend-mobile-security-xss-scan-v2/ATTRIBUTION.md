# Attribution for frontend-mobile-security-xss-scan-v2
...
- Upstream skill id: `frontend-mobile-security-xss-scan-v2`
- Upstream title: `XSS Vulnerability Scanner for Frontend Code`
- Upstream path: `skills/frontend-mobile-security-xss-scan-v2/`
