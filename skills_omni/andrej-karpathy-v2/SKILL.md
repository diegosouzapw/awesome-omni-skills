...
family_id: "andrej-karpathy-v2"
family_name: "ANDREJ KARPATHY \u2014 SKILL COMPLETA v2.0"
variant_id: "omni"
variant_label: "Omni Curated"
is_default_variant: true
derived_from: "skills/andrej-karpathy-v2"
upstream_skill: "skills/andrej-karpathy-v2"
...
```text
Review @andrej-karpathy-v2 against EXTERNAL_SOURCE.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
