...
family_id: "codenavi"
family_name: "CodeNavi"
variant_id: "omni"
variant_label: "Omni Curated"
is_default_variant: true
derived_from: "skills/codenavi"
...
```text
Review @codenavi against EXTERNAL_SOURCE.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
