...
family_id: "avoid-ai-writing"
family_name: "Avoid AI Writing \u2014 Audit & Rewrite"
variant_id: "omni"
variant_label: "Omni Curated"
is_default_variant: true
derived_from: "skills/avoid-ai-writing"
upstream_skill: "skills/avoid-ai-writing"
...
```text
Review @avoid-ai-writing against EXTERNAL_SOURCE.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
