# Attribution for fp-refactor-v2
...
- Upstream skill id: `fp-refactor-v2`
- Upstream title: `Refactoring Imperative Code to fp-ts`
- Upstream path: `skills/fp-refactor-v2/`
- Upstream author: `fp-ts-skills`
