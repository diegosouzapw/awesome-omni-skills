...
family_id: "apify-lead-generation-v2"
family_name: "Lead Generation"
variant_id: "omni"
variant_label: "Omni Curated"
is_default_variant: true
derived_from: "skills/apify-lead-generation-v2"
upstream_skill: "skills/apify-lead-generation-v2"
...
```text
Review @apify-lead-generation-v2 against EXTERNAL_SOURCE.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
