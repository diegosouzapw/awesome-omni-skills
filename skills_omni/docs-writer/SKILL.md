...
family_id: "docs-writer"
family_name: "docs-writer skill instructions"
variant_id: "omni"
variant_label: "Omni Curated"
is_default_variant: true
derived_from: "skills/docs-writer"
...
```text
Review @docs-writer against EXTERNAL_SOURCE.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
