# Attribution for app-store-changelog-v2
...
- Upstream skill id: `app-store-changelog-v2`
- Upstream title: `App Store Changelog`
- Upstream path: `skills/app-store-changelog-v2/`
