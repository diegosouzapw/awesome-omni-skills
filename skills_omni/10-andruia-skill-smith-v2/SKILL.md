...
family_id: "10-andruia-skill-smith-v2"
family_name: "\ud83d\udd28 Andru.ia Skill-Smith (The Forge)"
variant_id: "omni"
variant_label: "Omni Curated"
is_default_variant: true
derived_from: "skills/10-andruia-skill-smith-v2"
upstream_skill: "skills/10-andruia-skill-smith-v2"
...
```text
Review @10-andruia-skill-smith-v2 against EXTERNAL_SOURCE.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
