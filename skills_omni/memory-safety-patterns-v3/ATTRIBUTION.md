# Attribution for memory-safety-patterns-v3
...
- Upstream skill id: `memory-safety-patterns-v3`
- Upstream title: `Memory Safety Patterns`
- Upstream path: `skills/memory-safety-patterns-v3/`
