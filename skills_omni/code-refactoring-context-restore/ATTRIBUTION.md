# Attribution for code-refactoring-context-restore
...
- Upstream skill id: `code-refactoring-context-restore`
- Upstream title: `Context Restoration: Advanced Semantic Memory Rehydration`
- Upstream path: `skills/code-refactoring-context-restore/`
