# Attribution for bitbucket-automation-v2
...
- Upstream skill id: `bitbucket-automation-v2`
- Upstream title: `Bitbucket Automation via Rube MCP`
- Upstream path: `skills/bitbucket-automation-v2/`
