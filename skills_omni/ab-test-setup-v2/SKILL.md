...
family_id: "ab-test-setup-v2"
family_name: "A/B Test Setup"
variant_id: "omni"
variant_label: "Omni Curated"
is_default_variant: true
derived_from: "skills/ab-test-setup-v2"
upstream_skill: "skills/ab-test-setup-v2"
...
```text
Review @ab-test-setup-v2 against EXTERNAL_SOURCE.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
