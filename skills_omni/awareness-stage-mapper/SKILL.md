...
family_id: "awareness-stage-mapper"
family_name: "awareness-stage-mapper"
variant_id: "omni"
variant_label: "Omni Curated"
is_default_variant: true
derived_from: "skills/awareness-stage-mapper"
upstream_skill: "skills/awareness-stage-mapper"
...
```text
Review @awareness-stage-mapper against EXTERNAL_SOURCE.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
