# Attribution for error-debugging-multi-agent-review-v2
...
- Upstream skill id: `error-debugging-multi-agent-review-v2`
- Upstream title: `Multi-Agent Code Review Orchestration Tool`
- Upstream path: `skills/error-debugging-multi-agent-review-v2/`
