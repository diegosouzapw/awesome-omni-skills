# Attribution for claimable-postgres-v2
...
- Upstream skill id: `claimable-postgres-v2`
- Upstream title: `Claimable Postgres`
- Upstream path: `skills/claimable-postgres-v2/`
