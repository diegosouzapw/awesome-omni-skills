...
family_id: "web-quality-audit"
family_name: "Web quality audit"
variant_id: "omni"
variant_label: "Omni Curated"
is_default_variant: true
derived_from: "skills/web-quality-audit"
...
```text
Review @web-quality-audit against EXTERNAL_SOURCE.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
