# Attribution for auth-implementation-patterns-v2
...
- Upstream skill id: `auth-implementation-patterns-v2`
- Upstream title: `Authentication & Authorization Implementation Patterns`
- Upstream path: `skills/auth-implementation-patterns-v2/`
