# Attribution for cc-skill-project-guidelines-example-v2
...
- Upstream skill id: `cc-skill-project-guidelines-example-v2`
- Upstream title: `Project Guidelines Skill (Example)`
- Upstream path: `skills/cc-skill-project-guidelines-example-v2/`
