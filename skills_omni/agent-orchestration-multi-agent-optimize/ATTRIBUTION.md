# Attribution for agent-orchestration-multi-agent-optimize
...
- Upstream skill id: `agent-orchestration-multi-agent-optimize`
- Upstream title: `Multi-Agent Optimization Toolkit`
- Upstream path: `skills/agent-orchestration-multi-agent-optimize/`
