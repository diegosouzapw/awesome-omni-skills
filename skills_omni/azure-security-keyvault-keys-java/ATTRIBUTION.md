# Attribution for azure-security-keyvault-keys-java
...
- Upstream skill id: `azure-security-keyvault-keys-java`
- Upstream title: `Azure Key Vault Keys (Java)`
- Upstream path: `skills/azure-security-keyvault-keys-java/`
