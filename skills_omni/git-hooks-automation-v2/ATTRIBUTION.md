# Attribution for git-hooks-automation-v2
...
- Upstream skill id: `git-hooks-automation-v2`
- Upstream title: `Git Hooks Automation`
- Upstream path: `skills/git-hooks-automation-v2/`
