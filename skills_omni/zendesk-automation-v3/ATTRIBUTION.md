# Attribution for zendesk-automation-v3
...
- Upstream skill id: `zendesk-automation-v3`
- Upstream title: `Zendesk Automation via Rube MCP`
- Upstream path: `skills/zendesk-automation-v3/`
