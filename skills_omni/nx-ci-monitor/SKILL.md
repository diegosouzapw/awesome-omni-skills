...
family_id: "nx-ci-monitor"
family_name: "CI Monitor Command"
variant_id: "omni"
variant_label: "Omni Curated"
is_default_variant: true
derived_from: "skills/nx-ci-monitor"
...
```text
Review @nx-ci-monitor against EXTERNAL_SOURCE.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
