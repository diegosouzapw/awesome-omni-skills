# Attribution for app-store-optimization-v3
...
- Upstream skill id: `app-store-optimization-v3`
- Upstream title: `App Store Optimization (ASO) Skill`
- Upstream path: `skills/app-store-optimization-v3/`
