...
family_id: "agent-evaluation-v2"
family_name: "Agent Evaluation"
variant_id: "omni"
variant_label: "Omni Curated"
is_default_variant: true
derived_from: "skills/agent-evaluation-v2"
upstream_skill: "skills/agent-evaluation-v2"
...
```text
Review @agent-evaluation-v2 against EXTERNAL_SOURCE.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
