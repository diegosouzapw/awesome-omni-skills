...
family_id: "aegisops-ai-v2"
family_name: "/aegisops-ai \u2014 Autonomous Governance Orchestrator"
variant_id: "omni"
variant_label: "Omni Curated"
is_default_variant: true
derived_from: "skills/aegisops-ai-v2"
upstream_skill: "skills/aegisops-ai-v2"
...
```text
Review @aegisops-ai-v2 against EXTERNAL_SOURCE.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
