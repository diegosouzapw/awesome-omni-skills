# Attribution for agent-orchestration-improve-agent-v2
...
- Upstream skill id: `agent-orchestration-improve-agent-v2`
- Upstream title: `Agent Performance Optimization Workflow`
- Upstream path: `skills/agent-orchestration-improve-agent-v2/`
