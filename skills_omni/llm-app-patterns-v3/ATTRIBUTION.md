# Attribution for llm-app-patterns-v3
...
- Upstream skill id: `llm-app-patterns-v3`
- Upstream title: `🤖 LLM Application Patterns`
- Upstream path: `skills/llm-app-patterns-v3/`
