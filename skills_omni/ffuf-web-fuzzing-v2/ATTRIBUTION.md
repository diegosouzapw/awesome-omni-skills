# Attribution for ffuf-web-fuzzing-v2
...
- Upstream skill id: `ffuf-web-fuzzing-v2`
- Upstream title: `FFUF (Fuzz Faster U Fool) Skill`
- Upstream path: `skills/ffuf-web-fuzzing-v2/`
