# Attribution for gitlab-automation-v2
...
- Upstream skill id: `gitlab-automation-v2`
- Upstream title: `GitLab Automation via Rube MCP`
- Upstream path: `skills/gitlab-automation-v2/`
