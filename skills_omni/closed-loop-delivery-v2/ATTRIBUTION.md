# Attribution for closed-loop-delivery-v2
...
- Upstream skill id: `closed-loop-delivery-v2`
- Upstream title: `Closed-Loop Delivery`
- Upstream path: `skills/closed-loop-delivery-v2/`
