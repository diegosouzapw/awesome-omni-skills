...
family_id: "sentry"
family_name: "Sentry (Read-only Observability)"
variant_id: "omni"
...
```text
Review @sentry against EXTERNAL_SOURCE.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
