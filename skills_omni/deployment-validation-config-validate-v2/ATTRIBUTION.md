# Attribution for deployment-validation-config-validate-v2
...
- Upstream skill id: `deployment-validation-config-validate-v2`
- Upstream title: `Configuration Validation`
- Upstream path: `skills/deployment-validation-config-validate-v2/`
