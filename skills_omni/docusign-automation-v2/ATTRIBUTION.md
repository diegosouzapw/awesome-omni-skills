# Attribution for docusign-automation-v2
...
- Upstream skill id: `docusign-automation-v2`
- Upstream title: `DocuSign Automation via Rube MCP`
- Upstream path: `skills/docusign-automation-v2/`
