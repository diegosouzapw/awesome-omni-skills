# Attribution for sendgrid-automation-v3
...
- Upstream skill id: `sendgrid-automation-v3`
- Upstream title: `SendGrid Automation via Rube MCP`
- Upstream path: `skills/sendgrid-automation-v3/`
