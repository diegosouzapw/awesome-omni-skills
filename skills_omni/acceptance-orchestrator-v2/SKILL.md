...
family_id: "acceptance-orchestrator-v2"
family_name: "Acceptance Orchestrator"
variant_id: "omni"
variant_label: "Omni Curated"
is_default_variant: true
derived_from: "skills/acceptance-orchestrator-v2"
upstream_skill: "skills/acceptance-orchestrator-v2"
...
```text
Review @acceptance-orchestrator-v2 against EXTERNAL_SOURCE.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
