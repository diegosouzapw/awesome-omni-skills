...
family_id: "the-fool"
family_name: "The Fool"
variant_id: "omni"
variant_label: "Omni Curated"
is_default_variant: true
derived_from: "skills/the-fool"
...
```text
Review @the-fool against EXTERNAL_SOURCE.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
