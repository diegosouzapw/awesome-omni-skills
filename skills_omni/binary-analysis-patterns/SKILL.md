...
family_id: "binary-analysis-patterns"
family_name: "Binary Analysis Patterns"
variant_id: "omni"
variant_label: "Omni Curated"
is_default_variant: true
derived_from: "skills/binary-analysis-patterns"
upstream_skill: "skills/binary-analysis-patterns"
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/binary-analysis-patterns`, fails to mention provenance, or does not use any copied source files at all.
