# Attribution for framework-migration-deps-upgrade
...
- Upstream skill id: `framework-migration-deps-upgrade`
- Upstream title: `Dependency Upgrade Strategy`
- Upstream path: `skills/framework-migration-deps-upgrade/`
