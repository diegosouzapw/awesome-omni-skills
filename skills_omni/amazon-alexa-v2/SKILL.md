...
family_id: "amazon-alexa-v2"
family_name: "AMAZON ALEXA \u2014 Voz Inteligente com Claude"
variant_id: "omni"
variant_label: "Omni Curated"
is_default_variant: true
derived_from: "skills/amazon-alexa-v2"
upstream_skill: "skills/amazon-alexa-v2"
...
```text
Review @amazon-alexa-v2 against EXTERNAL_SOURCE.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
