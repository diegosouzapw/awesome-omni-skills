# Attribution for framework-migration-code-migrate
...
- Upstream skill id: `framework-migration-code-migrate`
- Upstream title: `Code Migration Assistant`
- Upstream path: `skills/framework-migration-code-migrate/`
