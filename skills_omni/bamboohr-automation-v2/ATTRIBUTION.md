# Attribution for bamboohr-automation-v2
...
- Upstream skill id: `bamboohr-automation-v2`
- Upstream title: `BambooHR Automation via Rube MCP`
- Upstream path: `skills/bamboohr-automation-v2/`
