# Attribution for agent-orchestration-improve-agent
...
- Upstream skill id: `agent-orchestration-improve-agent`
- Upstream title: `Agent Performance Optimization Workflow`
- Upstream path: `skills/agent-orchestration-improve-agent/`
