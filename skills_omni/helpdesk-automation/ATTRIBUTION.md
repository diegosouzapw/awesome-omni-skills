# Attribution for helpdesk-automation
...
- Upstream skill id: `helpdesk-automation`
- Upstream title: `HelpDesk Automation via Rube MCP`
- Upstream path: `skills/helpdesk-automation/`
