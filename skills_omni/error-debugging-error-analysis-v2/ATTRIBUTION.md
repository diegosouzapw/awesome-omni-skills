# Attribution for error-debugging-error-analysis-v2
...
- Upstream skill id: `error-debugging-error-analysis-v2`
- Upstream title: `Error Analysis and Resolution`
- Upstream path: `skills/error-debugging-error-analysis-v2/`
