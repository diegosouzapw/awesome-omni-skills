...
family_id: "audio-transcriber"
family_name: "Check for Faster-Whisper (preferred - 4-5x faster)"
variant_id: "omni"
variant_label: "Omni Curated"
is_default_variant: true
derived_from: "skills/audio-transcriber"
upstream_skill: "skills/audio-transcriber"
...
```text
Review @audio-transcriber against EXTERNAL_SOURCE.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
