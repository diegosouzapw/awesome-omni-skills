# Attribution for rag-implementation
...
- Upstream skill id: `rag-implementation`
- Upstream title: `RAG Implementation Workflow`
- Upstream path: `skills/rag-implementation/`
