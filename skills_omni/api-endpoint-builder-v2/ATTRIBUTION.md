# Attribution for api-endpoint-builder-v2
...
- Upstream skill id: `api-endpoint-builder-v2`
- Upstream title: `API Endpoint Builder`
- Upstream path: `skills/api-endpoint-builder-v2/`
