...
family_id: "api-endpoint-builder-v2"
family_name: "API Endpoint Builder"
variant_id: "omni"
variant_label: "Omni Curated"
is_default_variant: true
derived_from: "skills/api-endpoint-builder-v2"
upstream_skill: "skills/api-endpoint-builder-v2"
...
```text
Review @api-endpoint-builder-v2 against EXTERNAL_SOURCE.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
