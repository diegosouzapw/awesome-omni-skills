...
family_id: "apify-market-research-v2"
family_name: "Market Research"
variant_id: "omni"
variant_label: "Omni Curated"
is_default_variant: true
derived_from: "skills/apify-market-research-v2"
upstream_skill: "skills/apify-market-research-v2"
...
```text
Review @apify-market-research-v2 against EXTERNAL_SOURCE.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
