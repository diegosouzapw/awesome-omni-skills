# Attribution for dotnet-backend
...
- Upstream skill id: `dotnet-backend`
- Upstream title: `.NET Backend Agent - ASP.NET Core & Enterprise API Expert`
- Upstream path: `skills/dotnet-backend/`
