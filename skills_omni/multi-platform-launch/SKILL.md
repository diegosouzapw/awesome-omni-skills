...
family_id: "multi-platform-launch"
family_name: "Multi-Platform Launch Skill"
variant_id: "omni"
variant_label: "Omni Curated"
is_default_variant: true
derived_from: "skills/multi-platform-launch"
upstream_skill: "skills/multi-platform-launch"
...
```text
Review @multi-platform-launch against EXTERNAL_SOURCE.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
