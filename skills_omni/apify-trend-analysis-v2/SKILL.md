...
family_id: "apify-trend-analysis-v2"
family_name: "Trend Analysis"
variant_id: "omni"
variant_label: "Omni Curated"
is_default_variant: true
derived_from: "skills/apify-trend-analysis-v2"
upstream_skill: "skills/apify-trend-analysis-v2"
...
```text
Review @apify-trend-analysis-v2 against EXTERNAL_SOURCE.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
