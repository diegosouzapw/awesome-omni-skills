# Attribution for error-diagnostics-error-analysis
...
- Upstream skill id: `error-diagnostics-error-analysis`
- Upstream title: `Error Analysis and Resolution`
- Upstream path: `skills/error-diagnostics-error-analysis/`
