# Attribution for agent-orchestration-multi-agent-optimize-v2
...
- Upstream skill id: `agent-orchestration-multi-agent-optimize-v2`
- Upstream title: `Multi-Agent Optimization Toolkit`
- Upstream path: `skills/agent-orchestration-multi-agent-optimize-v2/`
