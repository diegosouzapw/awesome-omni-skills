...
family_id: "android-ui-verification-v2"
family_name: "Android UI Verification Skill"
variant_id: "omni"
variant_label: "Omni Curated"
is_default_variant: true
derived_from: "skills/android-ui-verification-v2"
upstream_skill: "skills/android-ui-verification-v2"
...
```text
Review @android-ui-verification-v2 against EXTERNAL_SOURCE.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
