...
family_id: "apify-influencer-discovery-v2"
family_name: "Influencer Discovery"
variant_id: "omni"
variant_label: "Omni Curated"
is_default_variant: true
derived_from: "skills/apify-influencer-discovery-v2"
upstream_skill: "skills/apify-influencer-discovery-v2"
...
```text
Review @apify-influencer-discovery-v2 against EXTERNAL_SOURCE.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
