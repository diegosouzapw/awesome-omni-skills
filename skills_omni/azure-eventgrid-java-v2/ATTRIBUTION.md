# Attribution for azure-eventgrid-java-v2
...
- Upstream skill id: `azure-eventgrid-java-v2`
- Upstream title: `Azure Event Grid SDK for Java`
- Upstream path: `skills/azure-eventgrid-java-v2/`
