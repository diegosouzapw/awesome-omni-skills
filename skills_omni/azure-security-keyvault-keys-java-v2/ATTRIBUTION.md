# Attribution for azure-security-keyvault-keys-java-v2
...
- Upstream skill id: `azure-security-keyvault-keys-java-v2`
- Upstream title: `Azure Key Vault Keys (Java)`
- Upstream path: `skills/azure-security-keyvault-keys-java-v2/`
