# Attribution for awt-e2e-testing-v2
...
- Upstream skill id: `awt-e2e-testing-v2`
- Upstream title: `AWT — AI-Powered E2E Testing (Beta)`
- Upstream path: `skills/awt-e2e-testing-v2/`
