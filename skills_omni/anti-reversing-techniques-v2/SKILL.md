...
family_id: "anti-reversing-techniques-v2"
family_name: "anti-reversing-techniques"
variant_id: "omni"
variant_label: "Omni Curated"
is_default_variant: true
derived_from: "skills/anti-reversing-techniques-v2"
upstream_skill: "skills/anti-reversing-techniques-v2"
...
```text
Review @anti-reversing-techniques-v2 against EXTERNAL_SOURCE.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
