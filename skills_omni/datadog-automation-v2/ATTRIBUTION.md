# Attribution for datadog-automation-v2
...
- Upstream skill id: `datadog-automation-v2`
- Upstream title: `Datadog Automation via Rube MCP`
- Upstream path: `skills/datadog-automation-v2/`
