# Attribution for azure-compute-batch-java-v2
...
- Upstream skill id: `azure-compute-batch-java-v2`
- Upstream title: `Azure Batch SDK for Java`
- Upstream path: `skills/azure-compute-batch-java-v2/`
