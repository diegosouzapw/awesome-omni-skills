# Attribution for error-diagnostics-error-analysis-v2
...
- Upstream skill id: `error-diagnostics-error-analysis-v2`
- Upstream title: `Error Analysis and Resolution`
- Upstream path: `skills/error-diagnostics-error-analysis-v2/`
