# Attribution for agent-memory-systems-v2
...
- Upstream skill id: `agent-memory-systems-v2`
- Upstream title: `Agent Memory Systems`
- Upstream path: `skills/agent-memory-systems-v2/`
