...
family_id: "agent-memory-systems-v2"
family_name: "Agent Memory Systems"
variant_id: "omni"
variant_label: "Omni Curated"
is_default_variant: true
derived_from: "skills/agent-memory-systems-v2"
upstream_skill: "skills/agent-memory-systems-v2"
...
```text
Review @agent-memory-systems-v2 against EXTERNAL_SOURCE.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
