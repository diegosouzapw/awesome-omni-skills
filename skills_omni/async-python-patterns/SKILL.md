...
family_id: "async-python-patterns"
family_name: "Async Python Patterns"
variant_id: "omni"
variant_label: "Omni Curated"
is_default_variant: true
derived_from: "skills/async-python-patterns"
upstream_skill: "skills/async-python-patterns"
...
```text
Review @async-python-patterns against EXTERNAL_SOURCE.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
