...
family_id: "paid-creative-ai"
family_name: "Paid Creative AI"
variant_id: "omni"
variant_label: "Omni Curated"
is_default_variant: true
derived_from: "skills/paid-creative-ai"
...
```text
Review @paid-creative-ai against EXTERNAL_SOURCE.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
