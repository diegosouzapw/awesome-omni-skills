...
family_id: "avalonia-layout-zafiro"
family_name: "Avalonia Layout with Zafiro.Avalonia"
variant_id: "omni"
variant_label: "Omni Curated"
is_default_variant: true
derived_from: "skills/avalonia-layout-zafiro"
upstream_skill: "skills/avalonia-layout-zafiro"
...
```text
Review @avalonia-layout-zafiro against EXTERNAL_SOURCE.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
