...
family_id: "api-documentation-generator-v2"
family_name: "API Documentation Generator"
variant_id: "omni"
variant_label: "Omni Curated"
is_default_variant: true
derived_from: "skills/api-documentation-generator-v2"
upstream_skill: "skills/api-documentation-generator-v2"
...
```text
Review @api-documentation-generator-v2 against EXTERNAL_SOURCE.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
