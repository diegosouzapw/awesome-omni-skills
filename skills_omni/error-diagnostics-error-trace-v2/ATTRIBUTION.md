# Attribution for error-diagnostics-error-trace-v2
...
- Upstream skill id: `error-diagnostics-error-trace-v2`
- Upstream title: `Error Tracking and Monitoring`
- Upstream path: `skills/error-diagnostics-error-trace-v2/`
