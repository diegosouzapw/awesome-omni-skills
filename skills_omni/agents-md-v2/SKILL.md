...
family_id: "agents-md-v2"
family_name: "Maintaining AGENTS.md"
variant_id: "omni"
variant_label: "Omni Curated"
is_default_variant: true
derived_from: "skills/agents-md-v2"
upstream_skill: "skills/agents-md-v2"
...
```text
Review @agents-md-v2 against EXTERNAL_SOURCE.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
