...
family_id: "api-security-best-practices-v2"
family_name: "API Security Best Practices"
variant_id: "omni"
variant_label: "Omni Curated"
is_default_variant: true
derived_from: "skills/api-security-best-practices-v2"
upstream_skill: "skills/api-security-best-practices-v2"
...
```text
Review @api-security-best-practices-v2 against EXTERNAL_SOURCE.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
