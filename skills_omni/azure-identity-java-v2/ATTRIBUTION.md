# Attribution for azure-identity-java-v2
...
- Upstream skill id: `azure-identity-java-v2`
- Upstream title: `Azure Identity (Java)`
- Upstream path: `skills/azure-identity-java-v2/`
