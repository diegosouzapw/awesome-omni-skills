# Attribution for circleci-automation-v2
...
- Upstream skill id: `circleci-automation-v2`
- Upstream title: `CircleCI Automation via Rube MCP`
- Upstream path: `skills/circleci-automation-v2/`
