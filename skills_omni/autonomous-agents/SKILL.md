...
family_id: "autonomous-agents"
family_name: "Autonomous Agents"
variant_id: "omni"
variant_label: "Omni Curated"
is_default_variant: true
derived_from: "skills/autonomous-agents"
upstream_skill: "skills/autonomous-agents"
...
```text
Review @autonomous-agents against EXTERNAL_SOURCE.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
