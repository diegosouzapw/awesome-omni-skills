# Attribution for azure-eventhub-java-v2
...
- Upstream skill id: `azure-eventhub-java-v2`
- Upstream title: `Azure Event Hubs SDK for Java`
- Upstream path: `skills/azure-eventhub-java-v2/`
