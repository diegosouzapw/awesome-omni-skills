# Attribution for cc-skill-project-guidelines-example
...
- Upstream skill id: `cc-skill-project-guidelines-example`
- Upstream title: `Project Guidelines Skill (Example)`
- Upstream path: `skills/cc-skill-project-guidelines-example/`
