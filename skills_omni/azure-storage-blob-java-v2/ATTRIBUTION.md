# Attribution for azure-storage-blob-java-v2
...
- Upstream skill id: `azure-storage-blob-java-v2`
- Upstream title: `Azure Storage Blob SDK for Java`
- Upstream path: `skills/azure-storage-blob-java-v2/`
