...
family_id: "ad-creative-v2"
family_name: "Ad Creative"
variant_id: "omni"
variant_label: "Omni Curated"
is_default_variant: true
derived_from: "skills/ad-creative-v2"
upstream_skill: "skills/ad-creative-v2"
...
```text
Review @ad-creative-v2 against EXTERNAL_SOURCE.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
