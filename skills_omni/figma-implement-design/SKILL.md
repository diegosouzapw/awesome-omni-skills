...
family_id: "figma-implement-design"
family_name: "Implement Design"
variant_id: "omni"
variant_label: "Omni Curated"
is_default_variant: true
derived_from: "skills/figma-implement-design"
...
```text
Review @figma-implement-design against EXTERNAL_SOURCE.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
