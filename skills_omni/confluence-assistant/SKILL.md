...
family_id: "confluence-assistant"
family_name: "Confluence Assistant"
variant_id: "omni"
variant_label: "Omni Curated"
is_default_variant: true
derived_from: "skills/confluence-assistant"
...
```text
Review @confluence-assistant against EXTERNAL_SOURCE.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
