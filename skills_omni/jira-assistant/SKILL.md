...
family_id: "jira-assistant"
family_name: "Jira Assistant"
variant_id: "omni"
variant_label: "Omni Curated"
is_default_variant: true
derived_from: "skills/jira-assistant"
...
```text
Review @jira-assistant against EXTERNAL_SOURCE.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
