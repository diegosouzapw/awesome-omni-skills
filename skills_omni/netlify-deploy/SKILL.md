...
family_id: "netlify-deploy"
family_name: "Netlify Deployment Skill"
variant_id: "omni"
variant_label: "Omni Curated"
is_default_variant: true
derived_from: "skills/netlify-deploy"
...
```text
Review @netlify-deploy against EXTERNAL_SOURCE.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
