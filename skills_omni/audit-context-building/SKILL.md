...
family_id: "audit-context-building"
family_name: "Deep Context Builder Skill (Ultra-Granular Pure Context Mode)"
variant_id: "omni"
variant_label: "Omni Curated"
is_default_variant: true
derived_from: "skills/audit-context-building"
upstream_skill: "skills/audit-context-building"
...
```text
Review @audit-context-building against EXTERNAL_SOURCE.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
