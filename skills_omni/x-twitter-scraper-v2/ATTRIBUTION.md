# Attribution for x-twitter-scraper-v2
...
- Upstream skill id: `x-twitter-scraper-v2`
- Upstream title: `X (Twitter) Scraper — Xquik`
- Upstream path: `skills/x-twitter-scraper-v2/`
