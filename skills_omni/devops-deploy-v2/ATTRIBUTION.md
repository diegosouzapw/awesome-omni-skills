# Attribution for devops-deploy-v2
...
- Upstream skill id: `devops-deploy-v2`
- Upstream title: `DEVOPS-DEPLOY — Da Ideia para Producao`
- Upstream path: `skills/devops-deploy-v2/`
