# Attribution for crypto-bd-agent-v2
...
- Upstream skill id: `crypto-bd-agent-v2`
- Upstream title: `Crypto BD Agent — Autonomous Business Development for Exchanges`
- Upstream path: `skills/crypto-bd-agent-v2/`
