# Attribution for frontend-mobile-security-xss-scan
...
- Upstream skill id: `frontend-mobile-security-xss-scan`
- Upstream title: `XSS Vulnerability Scanner for Frontend Code`
- Upstream path: `skills/frontend-mobile-security-xss-scan/`
