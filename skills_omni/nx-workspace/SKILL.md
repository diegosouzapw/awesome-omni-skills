...
family_id: "nx-workspace"
family_name: "Nx Workspace Management"
variant_id: "omni"
variant_label: "Omni Curated"
is_default_variant: true
derived_from: "skills/nx-workspace"
...
```text
Review @nx-workspace against EXTERNAL_SOURCE.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
