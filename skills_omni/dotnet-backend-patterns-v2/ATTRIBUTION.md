# Attribution for dotnet-backend-patterns-v2
...
- Upstream skill id: `dotnet-backend-patterns-v2`
- Upstream title: `.NET Backend Development Patterns`
- Upstream path: `skills/dotnet-backend-patterns-v2/`
