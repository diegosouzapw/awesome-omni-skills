# Attribution for conductor-validator-v2
...
- Upstream skill id: `conductor-validator-v2`
- Upstream title: `Check if conductor directory exists`
- Upstream path: `skills/conductor-validator-v2/`
