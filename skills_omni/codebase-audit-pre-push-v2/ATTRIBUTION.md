# Attribution for codebase-audit-pre-push-v2
...
- Upstream skill id: `codebase-audit-pre-push-v2`
- Upstream title: `Pre-Push Codebase Audit`
- Upstream path: `skills/codebase-audit-pre-push-v2/`
