...
family_id: "anti-reversing-techniques"
family_name: "anti-reversing-techniques"
variant_id: "omni"
variant_label: "Omni Curated"
is_default_variant: true
derived_from: "skills/anti-reversing-techniques"
upstream_skill: "skills/anti-reversing-techniques"
...
```text
Use @anti-reversing-techniques to handle <task>. Start from the copied upstream workflow, load only the files that change the outcome, and keep provenance visible in the answer.
```
...
```text
Review @anti-reversing-techniques against metadata.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
...
```text
Use @anti-reversing-techniques for <task>. Load only the copied references, examples, or scripts that change the outcome, and name the files explicitly before proceeding.
```
...
```text
Review @anti-reversing-techniques using the copied upstream files plus provenance, then summarize any gaps before merge.
```
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/anti-reversing-techniques`, fails to mention provenance, or does not use any copied source files at all.
