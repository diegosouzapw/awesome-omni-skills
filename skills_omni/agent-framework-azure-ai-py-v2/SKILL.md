...
family_id: "agent-framework-azure-ai-py-v2"
family_name: "Agent Framework Azure Hosted Agents"
variant_id: "omni"
variant_label: "Omni Curated"
is_default_variant: true
derived_from: "skills/agent-framework-azure-ai-py-v2"
upstream_skill: "skills/agent-framework-azure-ai-py-v2"
...
```text
Review @agent-framework-azure-ai-py-v2 against EXTERNAL_SOURCE.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
