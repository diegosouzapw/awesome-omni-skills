...
family_id: "apify-content-analytics-v2"
family_name: "Content Analytics"
variant_id: "omni"
variant_label: "Omni Curated"
is_default_variant: true
derived_from: "skills/apify-content-analytics-v2"
upstream_skill: "skills/apify-content-analytics-v2"
...
```text
Review @apify-content-analytics-v2 against EXTERNAL_SOURCE.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
