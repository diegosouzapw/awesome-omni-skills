# Attribution for async-python-patterns-v2
...
- Upstream skill id: `async-python-patterns-v2`
- Upstream title: `Async Python Patterns`
- Upstream path: `skills/async-python-patterns-v2/`
