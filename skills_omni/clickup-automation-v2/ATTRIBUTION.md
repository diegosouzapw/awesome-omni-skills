# Attribution for clickup-automation-v2
...
- Upstream skill id: `clickup-automation-v2`
- Upstream title: `ClickUp Automation via Rube MCP`
- Upstream path: `skills/clickup-automation-v2/`
