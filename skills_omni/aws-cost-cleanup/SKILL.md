...
family_id: "aws-cost-cleanup"
family_name: "AWS Cost Cleanup"
variant_id: "omni"
variant_label: "Omni Curated"
is_default_variant: true
derived_from: "skills/aws-cost-cleanup"
upstream_skill: "skills/aws-cost-cleanup"
...
```text
Review @aws-cost-cleanup against EXTERNAL_SOURCE.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
