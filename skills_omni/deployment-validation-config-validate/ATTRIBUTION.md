# Attribution for deployment-validation-config-validate
...
- Upstream skill id: `deployment-validation-config-validate`
- Upstream title: `Configuration Validation`
- Upstream path: `skills/deployment-validation-config-validate/`
