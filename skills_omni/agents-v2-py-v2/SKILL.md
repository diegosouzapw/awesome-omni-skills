...
family_id: "agents-v2-py-v2"
family_name: "Azure AI Hosted Agents (Python)"
variant_id: "omni"
variant_label: "Omni Curated"
is_default_variant: true
derived_from: "skills/agents-v2-py-v2"
upstream_skill: "skills/agents-v2-py-v2"
...
```text
Review @agents-v2-py-v2 against EXTERNAL_SOURCE.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
