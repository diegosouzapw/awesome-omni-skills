...
family_id: "create-rfc"
family_name: "RFC Creator"
variant_id: "omni"
variant_label: "Omni Curated"
is_default_variant: true
derived_from: "skills/create-rfc"
...
```text
Review @create-rfc against EXTERNAL_SOURCE.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
