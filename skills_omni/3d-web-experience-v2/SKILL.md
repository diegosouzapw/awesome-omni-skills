...
family_id: "3d-web-experience-v2"
family_name: "3D Web Experience"
variant_id: "omni"
variant_label: "Omni Curated"
is_default_variant: true
derived_from: "skills/3d-web-experience-v2"
upstream_skill: "skills/3d-web-experience-v2"
...
```text
Review @3d-web-experience-v2 against EXTERNAL_SOURCE.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
