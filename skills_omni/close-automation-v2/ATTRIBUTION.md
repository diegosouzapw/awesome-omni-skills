# Attribution for close-automation-v2
...
- Upstream skill id: `close-automation-v2`
- Upstream title: `Close CRM Automation via Rube MCP`
- Upstream path: `skills/close-automation-v2/`
