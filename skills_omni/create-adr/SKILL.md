...
family_id: "create-adr"
family_name: "ADR Creator"
variant_id: "omni"
variant_label: "Omni Curated"
is_default_variant: true
derived_from: "skills/create-adr"
...
```text
Review @create-adr against EXTERNAL_SOURCE.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
