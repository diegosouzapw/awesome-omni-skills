# Attribution for conductor-setup
...
- Upstream skill id: `conductor-setup`
- Upstream title: `What to Create`
- Upstream path: `skills/conductor-setup/`
- Upstream author: `Shpigford`
