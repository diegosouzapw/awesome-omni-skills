# Attribution for azure-messaging-webpubsubservice-py
...
- Upstream skill id: `azure-messaging-webpubsubservice-py`
- Upstream title: `Azure Web PubSub Service SDK for Python`
- Upstream path: `skills/azure-messaging-webpubsubservice-py/`
