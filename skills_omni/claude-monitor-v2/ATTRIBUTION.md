# Attribution for claude-monitor-v2
...
- Upstream skill id: `claude-monitor-v2`
- Upstream title: `Claude Monitor — Diagnóstico de Performance`
- Upstream path: `skills/claude-monitor-v2/`
