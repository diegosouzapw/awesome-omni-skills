# Attribution for framework-migration-code-migrate-v2
...
- Upstream skill id: `framework-migration-code-migrate-v2`
- Upstream title: `Code Migration Assistant`
- Upstream path: `skills/framework-migration-code-migrate-v2/`
