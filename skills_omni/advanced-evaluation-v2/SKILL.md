...
family_id: "advanced-evaluation-v2"
family_name: "Advanced Evaluation"
variant_id: "omni"
variant_label: "Omni Curated"
is_default_variant: true
derived_from: "skills/advanced-evaluation-v2"
upstream_skill: "skills/advanced-evaluation-v2"
...
```text
Review @advanced-evaluation-v2 against EXTERNAL_SOURCE.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
