...
family_id: "ai-agent-development-v2"
family_name: "AI Agent Development Workflow"
variant_id: "omni"
variant_label: "Omni Curated"
is_default_variant: true
derived_from: "skills/ai-agent-development-v2"
upstream_skill: "skills/ai-agent-development-v2"
...
```text
Review @ai-agent-development-v2 against EXTERNAL_SOURCE.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
