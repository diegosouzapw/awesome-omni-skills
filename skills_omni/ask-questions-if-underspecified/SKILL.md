...
family_id: "ask-questions-if-underspecified"
family_name: "Ask Questions If Underspecified"
variant_id: "omni"
variant_label: "Omni Curated"
is_default_variant: true
derived_from: "skills/ask-questions-if-underspecified"
upstream_skill: "skills/ask-questions-if-underspecified"
...
```text
Review @ask-questions-if-underspecified against EXTERNAL_SOURCE.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
