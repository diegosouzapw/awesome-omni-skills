...
family_id: "apify-actorization-v2"
family_name: "Apify Actorization"
variant_id: "omni"
variant_label: "Omni Curated"
is_default_variant: true
derived_from: "skills/apify-actorization-v2"
upstream_skill: "skills/apify-actorization-v2"
...
```text
Review @apify-actorization-v2 against EXTERNAL_SOURCE.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
